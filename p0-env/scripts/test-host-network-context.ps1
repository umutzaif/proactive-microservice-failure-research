...
$wifi=[pscustomobject]@{Name='Wi-Fi';InterfaceDescription='MediaTek Wi-Fi 6 MT7921 Wireless LAN Card';ifIndex=7;Status='Up';DriverVersion='3.0.1.1314';HardwareInterface=$true;NdisPhysicalMedium=9}
$ethernet=[pscustomobject]@{Name='Ethernet';InterfaceDescription='Realtek PCIe GbE Family Controller';ifIndex=5;Status='Up';DriverVersion='1168.8.515.2022';HardwareInterface=$true;NdisPhysicalMedium=14}
...
Write-Output 'host_network_windows_numeric_medium_fixture=passed'
