...
foreach($runId in @('ob-netdelay-500m-normal-15u-006','ob-netdelay-500m-normal-15u-002','ob-netdelay-500m-normal-10u-001','ob-netdelay-500m-normal-10u-004','ob-netdelay-500m-normal-15u-003','ob-netdelay-500m-normal-10u-003')){if(-not $text.Contains($runId) -or -not $metadataVerifier.Contains($runId)){throw "runner_metadata_id_contract_mismatch:$runId"}}
