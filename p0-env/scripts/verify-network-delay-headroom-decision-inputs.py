...
def verify(root: Path) -> list[str]:
    ...
    check("decisions", profile.get("decision_ids") == ["D-061", "D-062", "D-063", "D-066", "D-067", "D-068", "D-069", "D-070", "D-091", "D-110", "D-111", "D-112", "D-113"])
    ...
    check("replacement_blocked", sequence.get("next_slot_status") == "replacement_preregistered_manual_runtime_not_authorized")
    check("formula_and_sequence", formula.get("measurement_margin_ms") == "max(5.0, max(run_level_upper_tail_ms)-min(run_level_upper_tail_ms))" and sequence.get("random_seed") == 20260821 and sequence.get("original_randomized_run_ids") == ["ob-netdelay-500m-normal-15u-001", "ob-netdelay-500m-normal-15u-002", "ob-netdelay-500m-normal-10u-001", "ob-netdelay-500m-normal-10u-002", "ob-netdelay-500m-normal-15u-003", "ob-netdelay-500m-normal-10u-003"] and sequence.get("invalid_run_ids") == ["ob-netdelay-500m-normal-15u-001", "ob-netdelay-500m-normal-15u-004", "ob-netdelay-500m-normal-15u-005", "ob-netdelay-500m-normal-10u-002", "ob-netdelay-500m-normal-10u-004", "ob-netdelay-500m-normal-10u-005"] and sequence.get("effective_collection_run_ids") == ["ob-netdelay-500m-normal-15u-006", "ob-netdelay-500m-normal-15u-002", "ob-netdelay-500m-normal-10u-001", "ob-netdelay-500m-normal-10u-006", "ob-netdelay-500m-normal-15u-003", "ob-netdelay-500m-normal-10u-003"])
...
def main() -> int:
    ...
    print(json.dumps({"verification_passed": not failures, "checks": 13, "failures": failures}, sort_keys=True))
