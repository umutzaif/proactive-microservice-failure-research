...
def verify(root: Path) -> list[str]:
    ...
    check("decisions", profile.get("decision_ids") == ["D-061", "D-062", "D-063", "D-066", "D-067", "D-068", "D-069", "D-070", "D-091"])
