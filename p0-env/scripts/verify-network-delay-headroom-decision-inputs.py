...
def verify(root: Path) -> list[str]:
    ...
    check("decisions", profile.get("decision_ids") == ["D-061", "D-062", "D-063", "D-066", "D-067", "D-068"])
    ...
    check("formula_and_sequence", formula.get("measurement_margin_ms") == "max(5.0, max(run_level_upper_tail_ms)-min(run_level_upper_tail_ms))" and sequence.get("random_seed") == 20260821 and sequence.get("original_randomized_run_ids") == ["ob-netdelay-500m-normal-15u-001", "ob-netdelay-500m-normal-15u-002", "ob-netdelay-500m-normal-10u-001", "ob-netdelay-500m-normal-10u-002", "ob-netdelay-500m-normal-15u-003", "ob-netdelay-500m-normal-10u-003"] and sequence.get("invalid_run_ids") == ["ob-netdelay-500m-normal-15u-001"] and sequence.get("effective_collection_run_ids") == ["ob-netdelay-500m-normal-15u-004", "ob-netdelay-500m-normal-15u-002", "ob-netdelay-500m-normal-10u-001", "ob-netdelay-500m-normal-10u-002", "ob-netdelay-500m-normal-15u-003", "ob-netdelay-500m-normal-10u-003"])
    snapshot = profile.get("current_eligibility_snapshot", {})
    check("blocked_snapshot", snapshot.get("eligible_500m_normal_run_count_10u") == 0 and snapshot.get("eligible_500m_normal_run_count_15u") == 0 and snapshot.get("headroom_calculation_status") == "blocked_missing_new_500m_normals")
