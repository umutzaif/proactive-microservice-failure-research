...
$root=Join-Path $repo "p0-env\artifacts\P2-NETWORK-DELAY-SERVER-TERMINATION-DIAG-001\$DiagnosticId"
...
if($DiagnosticId-ne'ob-network-server-termination-001'){throw'unexpected_diagnostic_id'}
