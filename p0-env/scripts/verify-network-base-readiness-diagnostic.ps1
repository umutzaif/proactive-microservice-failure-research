[CmdletBinding()]
param([Parameter(Mandatory)][string]$ArtifactRoot,[string]$ExpectedDiagnosticId='ob-network-base-readiness-009')
...
if($manifest.predecessor_decision-ne'D-097'-or$manifest.predecessor_diagnostic_id-ne'ob-network-base-readiness-008'-or$manifest.predecessor_merge_revision-ne'63dc70aed38ec0a39dbccb9cede99cf9c3da347d'){throw 'predecessor_provenance_mismatch'}
