[CmdletBinding()]
param([Parameter(Mandatory)][string]$ArtifactRoot,[string]$ExpectedDiagnosticId='ob-network-base-readiness-010')
...
if($manifest.preregistration_decision-ne'D-099'-or$manifest.predecessor_decision-ne'D-098'-or$manifest.predecessor_diagnostic_id-ne'ob-network-base-readiness-009'-or$manifest.predecessor_merge_revision-ne'39f00a9317341b41d889fe79c6a5893e564d5954'){throw 'predecessor_provenance_mismatch'}
