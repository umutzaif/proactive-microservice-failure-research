...
foreach($case in @(
    ...
    @{id='ob-netdelay-500m-normal-10u-007';transport='wifi';error='d114_ethernet_only'},
    @{id='ob-netdelay-500m-normal-10u-007';transport='ethernet';error='background_load_note_required'}
)) {
