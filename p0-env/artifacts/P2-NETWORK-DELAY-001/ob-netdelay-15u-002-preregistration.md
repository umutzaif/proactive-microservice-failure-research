# P2-NETWORK-DELAY-001 / ob-netdelay-15u-002 replacement ön-kaydı

`ob-netdelay-15u-001` invalid/incomplete kanıtı korunmuş ve tekrar kullanımı
yasaklanmıştır. Bu replacement yalnız PowerShell 7 JSON DateTime dönüşümünün
canonical UTC olarak normalize edilmesini ekler; bilimsel koşulları değiştirmez.
