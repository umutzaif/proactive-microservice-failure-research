# P2-NETWORK-DELAY-001 / ob-netdelay-15u-004 replacement ön-kaydı

`ob-netdelay-15u-003` warmup/fault öncesi canlı proxy pod-count kapısında invalid/
incomplete korunmuş ve tekrar kullanımı yasaklanmıştır. Bu replacement yalnız bounded
tek-Ready-pod convergence ve exception host-after kapanışını ekler; bilimsel koşulları
değiştirmez.
