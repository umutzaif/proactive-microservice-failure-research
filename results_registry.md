...
| P2-KUBERNETES-BOOTSTRAP-DIAG-001 / ob-docker-disk-recovery-001 | 2026-09-02 | planned | D-093 ile disk-full sonrası clean reconstruction recoverability sınamak | Repository-only operational preregistration; Dataset/headroom dışı | C: free >=15 GiB before mutation; exact profile evidence/delete/absence; v1.34.0/4 CPU/6144 MiB/32 GiB/containerd; 180/5 | Runner/verifier contract hazır; ayrı onaylı Downloads temizliği sonrası C: free ~31,0 GiB gözlendi | `p0-env/artifacts/P2-KUBERNETES-BOOTSTRAP-DIAG-001/ob-docker-disk-recovery-001-preregistration.md` | Kapasite adayı hazır; merge delete/runtime yetkisi değildir; application/workload/fault yok |
