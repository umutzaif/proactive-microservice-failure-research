...
|---|---|---|---|---|---|---|---|---|
| P2-NETWORK-DELAY-HEADROOM-001 / ob-netdelay-500m-normal-10u-007 | 2026-09-10 | planned | D-114 manuel Ethernet replacement, özgün 10u-002 slotu | Veri üretilmedi | 10/1/1, no-toxic, 500m; tüm kapılar korunur | Henüz çalıştırılmadı | `p0-env/artifacts/P2-NETWORK-DELAY-HEADROOM-001/ob-netdelay-500m-normal-10u-007-preregistration.md` | 006 kapalı; 003 final; no-retry; merge ve ayrı runtime onayı gerekli |
| P2-NETWORK-DELAY-HEADROOM-001 / ob-netdelay-500m-normal-10u-006 | 2026-09-09 | invalid/incomplete | D-113 Ethernet replacement | Dataset/D-067 dışı | Yakınsama, 25 stabilite gözlemi ve baseline tamamlandı | archive_telemetry failed; Engine kaybı; rollback failed, stop 82; özgün host 0/0/0; 10 Eylül kontrolünde stopped/137/OOM false | `p0-env/artifacts/P2-NETWORK-DELAY-HEADROOM-001/ob-netdelay-500m-normal-10u-006-report.md` | ID kapalı; telemetry/metadata/receipt yok; D-067 10u 1/3, 15u 2/3; rollback doğrulanmadı |
| P2-NETWORK-DELAY-HEADROOM-001 / ob-netdelay-500m-normal-10u-005 | 2026-09-08 | invalid/incomplete | D-110 Ethernet replacement, özgün invalid 10u-002 yuvası | Dataset/D-067 dışı | Preflight/base/run-ID/workload geçti; target stability 2 pod nedeniyle durdu | Warm-up/baseline başlamadı; rollback ve stopped state doğrulandı; host 0/0/0, Ethernet sabit | `p0-env/artifacts/P2-NETWORK-DELAY-HEADROOM-001/ob-netdelay-500m-normal-10u-005-report.md` | ID kapalı; D-067 10u 1/3, 15u 2/3; 003 final slot; replacement yetkisiz |
...
| P2-NETWORK-DELAY-READINESS-DIAG-001 / ob-network-proxy-readiness-003 | 2026-08-15 | completed | O-018'i ayrıntılı pod/container/events/log kanıtıyla kapatmak | Geçerli tamamlanmış diagnostic; dataset/modeling dışı; fault yok | 180 sn / 5 sn; pod/container, deployment, ReplicaSet, events, current/previous log, rollback ve host | 33 gözlem; proxy Ready 33/33 ve 0 restart, server Ready 30/33 ve 1 restart; tek all-Ready pod 16,616 sn'de; 004'ün kalıcı failure'ı yeniden üretilmedi; rollback/host 0/0/0 geçti | `p0-env/artifacts/P2-NETWORK-DELAY-READINESS-DIAG-001/ob-network-proxy-readiness-003-report.md` | Proxy hatası gözlenmedi; geçici server probe timeout/restart görüldü. 004'ün kesin kök nedeni per-container kanıt yokluğundan geriye dönük kanıtlanamaz; ID kullanılmaz |
| P2-NETWORK-DELAY-REPLACEMENT-PREREG-004 / ob-netdelay-15u-005 | 2026-08-15 | completed | D-047 ile readiness evidence çözünürlüğünü artırmak ve değişmeyen replacement'ı ön-kaydetmek | Tooling/preregistration; dataset değil; fault yok | D-043 koşulları ve 120/5 sn kapı aynen; per-pod condition ve per-container readiness/restart/state | Runner contract, readiness fixtures, run-ID propagation ve prereg verifier | `p0-env/artifacts/P2-NETWORK-DELAY-001/ob-netdelay-15u-005-preregistration.md` | D-047; canonical merge + ayrı kullanıcı onayı + fresh kapılar gerekir |
| P2-NETWORK-DELAY-001 / ob-netdelay-15u-005 | 2026-08-15 | invalid | D-047 sonrası değişmeyen replacement'ı yürütmek | Dataset dışı invalid/incomplete preflight; fault yok | 120/5 sn ayrıntılı tek Ready proxy pod kapısı | 22 gözlem: pod count 2 sonra 21 kez 1; Ready 0/22; proxy 22/22 Ready/0 restart, yeni server 1/22 Ready ve restart 0->4, son durum CrashLoopBackOff, termination exit 137/Error; rollback, host 0/0/0 ve invalid receipt 9/9 geçti | `p0-env/artifacts/P2-NETWORK-DELAY-001/ob-netdelay-15u-005-report.md` | ID kullanılmaz; warmup/fault/telemetry yok. Exit 137 kesin OOM/kök neden kanıtı değildir; replacement bu sonuç commit'inde belirlenmez |
| P2-NETWORK-DELAY-SERVER-TERMINATION-DIAG-001 / ob-network-server-termination-001 | 2026-08-15 | completed | O-018 server exit 137/CrashLoopBackOff nedenini faultsuz ayrıştırmak | Geçerli tamamlanmış diagnostic; dataset/modeling dışı; toxic/fault yok | 180 sn / 5 sn; pod/container, events/describe/log, node/resource/metrics/kubelet, rollback/host | 33 gözlem; proxy 33/33 Ready/0 restart, server max 5 restart/CrashLoopBackOff; events 5 kez liveness-failed Killing; probe gRPC 8080 timeout 1 sn/period 5 sn/failure 3; node pressure false, OOMKilled yok, metrics API yok; rollback/host 0/0/0 | `p0-env/artifacts/P2-NETWORK-DELAY-SERVER-TERMINATION-DIAG-001/ob-network-server-termination-001-report.md` | Doğrudan neden kubelet liveness restart zinciri; timeout'un altında yatan responsiveness nedeni çözülemedi. ID kullanılmaz; replacement ayrı karar ister |
| P2-NETWORK-DELAY-PROBE-RESOURCE-DIAG-001 / ob-network-probe-resource-001 | 2026-08-15 | invalid | O-019 probe timeout ile CPU/throttling/memory/OOM/pressure zaman bağını faultsuz ölçmek | Invalid/incomplete diagnostic; dataset/modeling dışı; toxic/fault yok | 180 sn / 5 sn; cAdvisor Prometheus serileri + pod/event/log/node/rollback/host | Yeni pod server/proxy 33/33 Ready/0 restart; 5 readiness + 1 liveness timeout, Killing yok. CPU mean/max 32,466/373,423m; throttled-period %11,84; CPU pressure ~7,55 sn; memory max 33,242/450 MiB, failcnt/OOM/memory-pressure 0. Host WHEA count 881->879 non-monotonic; rollback geçti | `p0-env/artifacts/P2-NETWORK-DELAY-PROBE-RESOURCE-DIAG-001/ob-network-probe-resource-001-report.md` | Host-health kanıtı geçersiz ve restart yeniden üretilmedi; nedensellik kurulamaz. ID kullanılmaz, O-019 açık, replacement ayrı karar ister |
| P2-NETWORK-DELAY-PROBE-RESOURCE-DIAG-001 / ob-network-probe-resource-002 | 2026-08-15 | completed | D-048 RecordId host kapısıyla O-019 eşzamanlı resource tanısını değişmeden tekrarlamak | Geçerli tamamlanmış no-fault diagnostic; dataset/modeling dışı | Aynı no-toxic overlay, 180 sn / 5 sn, 13 cAdvisor seri; yeni WHEA 17/KP41/bugcheck 0; log reset fail-closed | Proxy 33/33 Ready/0 restart; server 1/33 Ready, max 5 restart, 5 liveness Killing. CPU mean/max 40,616/499,307m; throttled-period 363/363, CPU pressure +21,271 sn; memory max 25,46/450 MiB, failcnt/OOM/memory-pressure 0; node pressure yok; rollback/host/18-file offline replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-PROBE-RESOURCE-DIAG-001/ob-network-probe-resource-002-report.md` | CPU quota throttling/pressure yakın mekanizma olarak güçlü desteklenir; tek nihai kök neden veya replacement ayarı kanıtlanmaz |
| P2-NETWORK-DELAY-RESOURCE-COMPAT-DESIGN-001 / ob-network-resource-compat-001 | 2026-08-20 | planned | Probe/request/memory sabitken 500m server CPU limitinin no-toxic compatibility etkisini sınamak | Tooling/preregistration; dataset/modeling dışı; fault yok | 120/5 stability + 180/5 measurement; Ready %100/restart 0; 13 metric/175 sn; throttling <0,50; CPU pressure <10,635359 sn; host/node/rollback/seal | Tek-op patch, positive/2 negative fixture ve rendered server/proxy/probe sözleşmesi geçti; canlı run henüz yürütülmedi | `p0-env/artifacts/P2-NETWORK-DELAY-RESOURCE-COMPAT-DESIGN-001/report.md` | D-050; canonical merge + ayrı runtime onayı gerekir; geçiş scientific fault yetkisi değildir |
| P2-NETWORK-DELAY-RESOURCE-COMPAT-001 / ob-network-resource-compat-001 | 2026-08-20 | invalid | D-050 500m no-toxic resource compatibility kapısını yürütmek | Invalid/incomplete preflight; dataset/modeling dışı; fault yok | Fresh Git/ID/host/deploy/run-ID/workload; sonra 120/5 + 180/5 | Base kapılar geçti; overlay sonrası kubectl birleşik çıktısındaki JSON dışı satır ConvertFrom-Json'ı durdurdu. Stability/measurement başlamadı; rollback doğrulaması aynı parser kusuruyla eksik; Minikube stopped, host 0/0/0, 4/4 offline seal geçti | `p0-env/artifacts/P2-NETWORK-DELAY-RESOURCE-COMPAT-001/ob-network-resource-compat-001-report.md` | ID kullanılmaz; koşul/eşik değişmez; parser fix ve replacement ayrı commit gerekir |
| P2-NETWORK-DELAY-RESOURCE-COMPAT-REPLACEMENT-001 / ob-network-resource-compat-002 | 2026-08-20 | invalid | D-051 JSON kanal ayrımıyla D-050 koşullarını değişmeden yeniden yürütmek | Invalid/incomplete preflight; dataset/modeling dışı; fault yok | Fresh Git/ID/RecordId-host/deploy/run-ID/workload; sonra değişmeyen D-050 kapıları | Base, run-ID ve workload geçti; overlay rollout sonrası doğrudan kubectl çıktısındaki JSON dışı `k...` parser'ı durdurdu. Stability/measurement/fiziksel etki başlamadı; rollback verifier eksik artifact ile fail. Minikube stopped, host 0/0/0, 4/4 offline seal geçti | `p0-env/artifacts/P2-NETWORK-DELAY-RESOURCE-COMPAT-001/ob-network-resource-compat-002-report.md` | ID kullanılmaz; koşul/eşik değişmez; kök neden tanısı ve replacement ayrı kontrollü commit ister |
| P2-NETWORK-DELAY-RESOURCE-COMPAT-REPLACEMENT-002 / ob-network-resource-compat-003 | 2026-08-20 | invalid | D-052 native JSON stdout/stderr fiziksel izolasyonuyla D-050'yi değişmeden yeniden yürütmek | Invalid/incomplete preflight; dataset/modeling dışı; fault yok | Fresh Git/ID/RecordId-host/deploy/run-ID/workload; sonra değişmeyen D-050 kapıları | Base, run-ID ve workload geçti; KJson `$Args` otomatik değişken çakışması helper'a boş argüman verdi. Stability/measurement/fiziksel etki başlamadı; rollback verifier eksik artifact ile fail. Minikube stopped, host 0/0/0, 4/4 seal/replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-RESOURCE-COMPAT-001/ob-network-resource-compat-003-report.md` | ID kullanılmaz; koşul/eşik değişmez; binding fix ve replacement ayrı kontrollü commit ister |
| P2-NETWORK-DELAY-RESOURCE-COMPAT-REPLACEMENT-003 / ob-network-resource-compat-004 | 2026-08-20 | invalid | D-053 sonrası D-050'yi değişmeden yürütmek | Invalid provenance; dataset/modeling dışı; fault yok | 120/5 + 180/5; 13 metric/175 sn; physical/lifecycle/host/rollback/seal ve verifier run-ID | 23+34 stabil örnek, 13/13 ve 180 sn; throttling 18/1127=%1,597, CPU pressure +0,535 sn, memory/OOM/node/host temiz, rollback ve 19/19 seal geçti. Verifier hard-coded `002` run-ID yazdı ve ID gate'i yoktu | `p0-env/artifacts/P2-NETWORK-DELAY-RESOURCE-COMPAT-001/ob-network-resource-compat-004-report.md` | Fiziksel kapılar geçti fakat provenance verifier çelişkisi nedeniyle invalid; ID kullanılmaz, eşikler değişmez |
| P2-NETWORK-DELAY-RESOURCE-COMPAT-REPLACEMENT-004 / ob-network-resource-compat-005 | 2026-08-20 | valid | D-054 provenance kapısıyla D-050'yi değişmeden yürütmek | Geçerli no-toxic compatibility; dataset/modeling dışı; fault yok | 120/5 + 180/5; 13 metric/175 sn; physical/lifecycle/host/rollback/seal + expected/folder/manifest ID | 23+34 stabil örnek, 13/13 ve 180 sn; throttling 16/1154=%1,386, CPU pressure +0,498 sn; memory/OOM/node/host temiz, rollback, provenance ve 19/19 seal/replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-RESOURCE-COMPAT-001/ob-network-resource-compat-005-report.md` | D-050/O-020 kapanır; scientific fault veya sonraki aşama yetkisi değildir |
| P2-NETWORK-DELAY-001 / ob-netdelay-15u-006 | 2026-08-20 | invalid | D-055 500m scientific replacement'ı yürütmek | Invalid/incomplete preflight; dataset değil; fault yok | Fresh gates + compositional overlay verifier | Deploy/run-ID/workload/convergence geçti; verifier base patch'i üst klasörde arayıp durdu. Warmup/fault yok; rollback, host 0/0/0 ve 6/6 seal geçti | `p0-env/artifacts/P2-NETWORK-DELAY-001/ob-netdelay-15u-006-report.md` | ID kullanılmaz; eşikler değişmez; verifier fix/replacement ayrı commit ister |
| P2-NETWORK-DELAY-REPLACEMENT-PREREG-006 / ob-netdelay-15u-007 | 2026-08-20 | planned | Compositional overlay verifier kaynağını ayırarak D-055'i değişmeden yürütmek | Tooling/preregistration; fault yok | Deployed 500m overlay + source design verifier; diğer tüm kapılar aynı | Runner contract ve proxy fixture'ları; canlı run yok | `p0-env/artifacts/P2-NETWORK-DELAY-001/ob-netdelay-15u-007-preregistration.md` | Merge + ayrı runtime onayı gerekir |
| P2-NETWORK-DELAY-001 / ob-netdelay-15u-007 | 2026-08-20 | invalid | D-056 replacement'ını yürütmek | Invalid/incomplete entrypoint; dataset değil; lifecycle/fault yok | Git/contract/RecordId-host/Docker/Minikube başlangıç kapıları | Runner `ShouldProcess` non-interactive çağrıda preflight öncesi null-reference üretti; Minikube stopped kaldı, host 0/0/0 ve 5/5 diagnostic seal/replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-001/ob-netdelay-15u-007-report.md` | ID kullanılmaz; bilimsel eşikler değerlendirilmedi/değişmez; replacement ayrı commit ister |
| P2-NETWORK-DELAY-REPLACEMENT-PREREG-007 / ob-netdelay-15u-008 | 2026-08-20 | planned | D-057 ile non-interactive entrypoint'i düzeltip D-055/D-056'yı değişmeden yürütmek | Tooling/preregistration; fault yok | Mandatory ExecutionApproved + ConfirmImpact Low + WhatIf; diğer tüm kapılar aynı | Static runner contract ve subprocess WhatIf no-mutation fixture | `p0-env/artifacts/P2-NETWORK-DELAY-001/ob-netdelay-15u-008-preregistration.md` | Merge + ayrı runtime onayı gerekir |
| P2-NETWORK-DELAY-001 / ob-netdelay-15u-008 | 2026-08-20 | completed | D-055/D-056/D-057 altında ilk geçerli 500m network-delay bilimsel run'ını toplamak | Geçerli exploratory 750ms pilot; yeni ladder/confirmatory sayıya dahil değil | 15/1/1; D-038; 300/300/120/300/300; 0->750 ms; effect >=500 ms | D-038 25/restart 0; coverage 60/60; median 3,238->755,233 ms, effect +751,995 ms; latency manifestation 18:25:43.328Z; host 0/0/0; raw/enriched/schema-v3/final replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-001/ob-netdelay-15u-008-report.md` | D-066 sonrası yalnız tarihsel exploratory kanıt; 25/50/100/250/500ms ladder hücresi veya 60-incident confirmatory örneği değildir |
| P2-NETWORK-DELAY-REPEATABILITY-001 | 2026-08-21 | superseded | D-058 shell-portability kapısını kapatıp dört randomize eşlenmiş kontrol/fault blokta run-arası varyansı ölçmek | İlk fault slotundan sonra D-061–D-066 ile ileriye dönük durduruldu | `008` set dışı pilot; seed 20260821; F-C,F-C,C-F,C-F; aynı overlay/workload/resource/lifecycle; fault >=500 ms | pwsh5.1/pwsh7 portability geçti ve ilk fault slotu valid tamamlandı; kalan slotlar yürütülmedi | `p0-env/artifacts/P2-NETWORK-DELAY-REPEATABILITY-001/preregistration.md` | Tarihsel plan korunur; kalan 750ms slotlar çalıştırılmaz; yeni yol headroom, 500m baseline reset, probe ayrımı ve ladder'dır |
| P2-NETWORK-DELAY-REPEATABILITY-001 / ob-netdelay-15u-repeat-001 | 2026-08-21 | completed | D-059 ile ilk randomize fault slotunu değişmeyen `008` koşullarında toplamak | Geçerli exploratory 750ms pilot; yeni ladder/confirmatory sayıya dahil değil | 15/1/1; 500m/100m; D-038; 300/300/120/300/300; 0->750 ms; effect >=500 ms | D-038 25/restart 0; coverage 60/60; median 5,548->755,171 ms; effect +749,623 ms; first symptom 29,397 sn; latency manifestation 104,397 sn; host 0/0/0; raw/enriched/schema-v3/final replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-REPEATABILITY-001/ob-netdelay-15u-repeat-001-report.md` | D-066 sonrası tarihsel exploratory kanıt; control-001 yürütülmez ve blok confirmatory paired sonuç sayılmaz |
| P2-NETWORK-DELAY-CONTROL-CONTRACT-001 / ob-netdelay-15u-control-001 | 2026-08-21 | superseded | D-060 ile ilk paired no-toxic kontrolün metadata ve geçerlilik semantiğini dondurmak | Uygulanmamış contract; runner/canlı kontrol yok | Aynı overlay/15/1/1/500m/100m/300-300-120-300-300; toxic yok; matched intervals; coverage >=48/48; null manifestation | 11-check static contract verifier; canlı kanıt üretilmedi | `p0-env/artifacts/P2-NETWORK-DELAY-REPEATABILITY-001/ob-netdelay-15u-control-001-contract.md` | D-066 ile yürütülemez; profil `superseded_not_executable`, run ID kullanılmaz |
| P2-NETWORK-DELAY-HEADROOM-001 | 2026-08-21 | planned | D-061–D-063 için fault öncesi yeniden üretilebilir headroom girdilerini ve mevcut kanıt sınırını tanımlamak | D-067 decision-support + collection prereg; fault/severity seçimi yok | 500m/100m; no-toxic proxy; 10u+15u; ladder 25/50/100/250/500ms; frozen 594,664ms SLO; workload başına >=3 bağımsız yeni normal | 12-check verifier; eligible 0/3+0/3; max + max(5ms, range); seed 20260821 sıra donduruldu; leakage/authorization/choice negatifleri | `p0-env/artifacts/P2-NETWORK-DELAY-HEADROOM-001/preregistration.md` | Tooling commitinden sonra bu aşamaya özgü genel onayla altı no-fault run; fault ve severity seçimi yok |
| P2-NETWORK-DELAY-HEADROOM-TOOLING-001 | 2026-08-21 | completed | D-067 altı yeni 500m no-toxic normalin P2-özgü runner/analyzer/metadata kapılarını uygulamak | Tooling; canlı run/fault yok | pre/post clean; 500m/100m/100m; 120s stability; 300/300; 60/48; null SLO; pod/host/schema-v3/rollback/receipt | Runner parse/no-fault/gates; analyzer coverage+manifestation negative; metadata toxic negative; generic dispatch geçti | `p0-env/scripts/run-network-delay-headroom-normal.ps1` | Merge beklemeden aynı kullanıcı-onaylı aşama dalında commit; ilk run bağı ve WhatIf sonraki immutable commit |
| P2-NETWORK-DELAY-HEADROOM-001 / ob-netdelay-500m-normal-15u-001 | 2026-08-21 | invalid | D-067 randomize sıranın ilk 15u no-toxic proxy normalini toplamak | Dataset/headroom dışı invalid normal; fault yok | 15u/rate1/seed1; 500m/100m/100m; no-toxic; 120s stability; 300/300; 60/48; null SLO; pod/host/schema-v3/rollback/receipt | Bilimsel pencere, 60/60 coverage, null manifestation, pod/host/schema-v3 ve rollback geçti; tanısal üst-kuyruk 299,901 ms; PowerShell `$Host` çakışması metadata/final receipt öncesi kapanışı durdurdu | `p0-env/artifacts/P2-NETWORK-DELAY-HEADROOM-001/ob-netdelay-500m-normal-15u-001-report.md` | Sonuç D-067 hesabına alınmaz; immutable invalid receipt ile korunur, ID tekrar kullanılmaz ve eşikler değişmez |
| P2-NETWORK-DELAY-HEADROOM-001 / ob-netdelay-500m-normal-15u-004 | 2026-08-21 | invalid | D-068 ile invalid ilk 15u sıra slotunu aynı koşullarda telafi etmek | Dataset/headroom dışı invalid normal; fault yok | 15u/rate1/seed1; 500m/100m/100m; no-toxic; 120s stability; 300/300; 60/48; null SLO; pod/host/schema-v3/rollback/receipt | Bilimsel pencere, raw/enriched/schema-v3, null manifestation, pod/host ve rollback geçti; tanısal üst-kuyruk 605,978 ms; metadata verifier eski allowlist nedeniyle kimliği reddetti ve final receipt oluşmadı | `p0-env/artifacts/P2-NETWORK-DELAY-HEADROOM-001/ob-netdelay-500m-normal-15u-004-report.md` | Sonuç D-067 hesabına alınmaz; immutable invalid receipt ile korunur, ID tekrar kullanılmaz |
| P2-NETWORK-DELAY-HEADROOM-001 / ob-netdelay-500m-normal-15u-005 | 2026-08-21 | invalid | D-069 ile invalid ilk sıra slotunu aynı dondurulmuş koşullarda yeniden telafi etmek | Dataset/headroom dışı invalid normal; fault yok | 15u/rate1/seed1; 500m/100m/100m; no-toxic; 120s stability; 300/300; 60/48; null SLO; pod/host/schema-v3/rollback/receipt | Metadata 15/15 dahil bilimsel/operasyonel kapılar geçti; tanısal üst-kuyruk 1082,282 ms; shared finalizer top-level `random_seed` yokluğunu StrictMode altında reddetti ve partial receipt `_invalid` altında korundu | `p0-env/artifacts/P2-NETWORK-DELAY-HEADROOM-001/ob-netdelay-500m-normal-15u-005-report.md` | Valid final receipt yok; sonuç D-067 hesabına alınmaz, ID tekrar kullanılmaz |
| P2-NETWORK-DELAY-HEADROOM-001 / ob-netdelay-500m-normal-15u-006 | 2026-08-21 | completed | D-070 ile invalid ilk slotu açık seed provenance ile aynı koşullarda telafi etmek | Geçerli D-067 normal headroom girdisi; fault yok | 15u/rate1/seed1; 500m/100m/100m; no-toxic; 120s stability; 300/300; 60/48; null SLO; pod/host/schema-v3/rollback/receipt | Üst-kuyruk 539,155 ms; 60/60 nonempty; null manifestation; raw 17/17; enriched 26.475; telemetry 25/25, 514.271 sample, 3.803 trace, 47.714 span; metadata 15/15; pod/host/rollback/final receipt replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-HEADROOM-001/ob-netdelay-500m-normal-15u-006-report.md` | İlk geçerli 15u tekrar: 1/3; tek başına repeatability/headroom/severity kararı üretmez |
| P2-NETWORK-DELAY-HEADROOM-001 / ob-netdelay-500m-normal-15u-002 | 2026-08-21 | completed | D-067 etkili sıranın ikinci 15u no-toxic normalini toplamak | Geçerli D-067 normal headroom girdisi; fault yok | 15u/rate1/seed1; 500m/100m/100m; no-toxic; 120s stability; 300/300; 60/48; null SLO; pod/host/schema-v3/rollback/receipt | Üst-kuyruk 374,397 ms; 60/60 nonempty; null manifestation; raw 17/17; enriched 26.110; telemetry 25/25, 505.206 sample, 3.750 trace, 46.445 span; metadata 15/15; pod/host/rollback/final receipt replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-HEADROOM-001/ob-netdelay-500m-normal-15u-002-report.md` | İkinci geçerli 15u tekrar: 2/3; iki-run spread 164,758 ms yalnız betimsel, headroom/severity kararı yok |
| P2-NETWORK-DELAY-HEADROOM-001 / ob-netdelay-500m-normal-10u-001 | 2026-08-21 | completed | D-067 etkili sıranın ilk 10u no-toxic normalini toplamak | Geçerli D-067 normal headroom girdisi; fault yok | 10u/rate1/seed1; 500m/100m/100m; no-toxic; 120s stability; 300/300; 60/48; null SLO; pod/host/schema-v3/rollback/receipt | Üst-kuyruk 612,248 ms; 60/60 nonempty; manifestation null; raw 17/17; enriched 20.340; telemetry 25/25, 508.877 sample, 3.112 trace, 33.165 span; metadata 15/15; pod/host/rollback/final receipt replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-HEADROOM-001/ob-netdelay-500m-normal-10u-001-report.md` | İlk geçerli 10u tekrar: 1/3; tek maksimum SLO eşiğini aşsa da üç ardışık ihlal yok, headroom/severity kararı yok |
| P2-NETWORK-DELAY-HEADROOM-001 / ob-netdelay-500m-normal-10u-002 | 2026-08-22 | invalid | D-067 etkili sıranın ikinci 10u no-toxic normalini toplamak | Dataset/headroom dışı invalid preflight; fault yok | 10u/rate1/seed1; 500m/100m/100m; no-toxic; deployment/stability/warmup/baseline/receipt kapıları | Base deployment availability recommendationservice üzerinde timeout; warmup/baseline başlamadı; rollback rollout da timeout, Minikube stopped; host 0/0/0; diagnostic seal/replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-HEADROOM-001/ob-netdelay-500m-normal-10u-002-report.md` | 10u sayacı 1/3 kalır; ID kullanılmaz, eşikler değişmez; D-071 base readiness tanısı onaylı, replacement yetkisiz |
| P2-NETWORK-DELAY-HEADROOM-001 / ob-netdelay-500m-normal-10u-004 | 2026-09-01 | invalid | D-091 ile invalid `10u-002` yuvasını aynı D-067 koşullarında telafi etmek | Invalid/incomplete preflight; Dataset/headroom dışı; fault yok | Canonical `2c85414`; 10u/rate1/seed1; base deployment öncesi/sonrası kapılar | Docker disk-full ile eşzamanlı API kaybı; `step_failed:deploy_base`; warm-up/baseline yok; rollback apply ve profile stop başarısız; host-after yok; üç runner dosyası + assessment sealed | `p0-env/artifacts/P2-NETWORK-DELAY-HEADROOM-001/ob-netdelay-500m-normal-10u-004-report.md` | ID kapalı; D-067 10u 1/3, 15u 2/3; disk cleanup/recovery/replacement ayrı onaylı |
| P2-KUBERNETES-BOOTSTRAP-DIAG-001 / ob-docker-disk-recovery-001 | 2026-09-02 | valid | D-093 ile disk-full sonrası clean reconstruction recoverability sınamak | D-094 completed operational diagnostic; Dataset/headroom dışı | Canonical `86cb3d9`; C: free >=15 GiB; exact delete/absence; v1.34.0/4 CPU/6144 MiB/32 GiB/containerd; 180/5 | ~23,98 GiB preflight; delete/yokluk; 31/31 healthy; 1 Ready node; 8/8 kube-system Running; host 0/0/0; stopped exit 130/OOM false; verifier ve 12-file replay geçti | `p0-env/artifacts/P2-KUBERNETES-BOOTSTRAP-DIAG-001/ob-docker-disk-recovery-001-report.md` | ID kapalı; clean reconstruction desteklenir, unique cause/application/D-067/replacement/fault kanıtı değildir |
| P2-NETWORK-DELAY-BASE-READINESS-DIAG-001 / ob-network-base-readiness-001 | 2026-08-27 | invalid | D-071 altında `10u-002` sonrası taze base recommendationservice readiness/stability kanıtı toplamak | Invalid/incomplete operasyonel preflight; dataset/headroom dışı; fault yok | Mevcut base + 10u workload; overlay yok; 900/5 + 180/5 planı | Docker Linux engine yoktu; Minikube/deployment/gözlem başlamadı. Erken hata yolunda bitişik `throw` tokenization kusuru görüldü; host 0/0/0 ve 4-file seal/replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-BASE-READINESS-DIAG-001/ob-network-base-readiness-001-report.md` | ID kullanılmaz; recommendationservice sonucu yok. D-072 aynı koşullu `002` replacement'ını bağlar |
| P2-NETWORK-DELAY-BASE-READINESS-DIAG-001 / ob-network-base-readiness-002 | 2026-08-28 | invalid | D-072 ile altyapı-preflight invalid `001`i aynı D-071 koşullarında telafi etmek | Invalid/incomplete operasyonel preflight; dataset/headroom dışı; toxic/fault yok | Docker ready; mevcut base + 10u; overlay yok; 900/5 convergence + Available sonrası 180/5 stability; host/seal/replay | Docker Engine 29.7.2, contract ve WhatIf geçti; Minikube node oluştu fakat API server süreci hiç görünmedi ve `K8S_APISERVER_MISSING` verdi. Deployment/workload/gözlem başlamadı; cluster stopped, host 0/0/0 ve 4-file SHA replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-BASE-READINESS-DIAG-001/ob-network-base-readiness-002-report.md` | ID kullanılmaz; recommendationservice sonucu ve D-067 sayım değişikliği yok. Sonraki tanı/replacement ayrı karar ve yeni ID ister |
| P2-KUBERNETES-BOOTSTRAP-DIAG-001 / ob-k8s-bootstrap-001 | 2026-08-28 | valid | `002` öncesi stale Minikube persistent-state hipotezini temiz bootstrap ile sınamak | Geçerli operasyonel altyapı tanısı; dataset/headroom dışı; application/workload/toxic/fault yok | Eski container/volume/log kanıtı; exact-profile delete ve yokluk doğrulaması; değişmeyen v1.34.0/4 CPU/6144 MiB/32 GiB/containerd; 180/5 system stability; host/seal/replay | Delete yokluğu geçti; clean start başarılı; 30/30 host+kubelet+apiserver Running ve kubeconfig Configured; host 0/0/0, cluster stopped, semantic verifier ve 12/12 SHA replay geçti | `p0-env/artifacts/P2-KUBERNETES-BOOTSTRAP-DIAG-001/ob-k8s-bootstrap-001-report.md` | Stale karışık state hipotezi desteklenir, eski volume tek neden olarak kanıtlanmaz; recommendationservice veya replacement normal yetkisi yoktur |
| P2-NETWORK-DELAY-BASE-READINESS-DIAG-001 / ob-network-base-readiness-003 | 2026-08-28 | invalid | D-073 clean bootstrap sonrası eksik recommendationservice base readiness/stability gözlemini toplamak | Invalid/incomplete operasyonel preflight; dataset/headroom dışı; toxic/fault yok | Canonical `bb98f28`; Docker 29.7.2; mevcut base + 10u; overlay yok; değişmeyen 900/5 + 180/5 planı | Minikube API server süreci altı dakikada hiç oluşmadı; `K8S_APISERVER_MISSING/minikube_start_failed`. Deployment/workload/gözlem başlamadı; cluster stopped, host 0/0/0 ve 4-file SHA replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-BASE-READINESS-DIAG-001/ob-network-base-readiness-003-report.md` | ID kullanılmaz; D-073 geriye dönük değişmez, recommendationservice sonucu yoktur; D-067 15u 2/3, 10u 1/3 kalır ve sonraki adım ayrı karar ister |
| P2-MINIKUBE-STATE-POSTMORTEM-001 / ob-minikube-state-postmortem-001 | 2026-08-29 | valid | D-075 sonrası gerçek state-root provenance'ını ve durmuş profile'ın erişilebilir postmortem kanıtını toplamak | Geçerli D-076 read-only operasyonel kanıt; dataset/headroom dışı; application/workload/fault yok | Canonical `8f88f70`; external/resolved/expected MINIKUBE_HOME; exact profile/container/volume; config/lastStart/Docker/Minikube logs; no mutation; semantic verifier/seal | Repository-local root eşleşti; Docker 29.7.2; container exited/restart 0/OOM false/exit 130; volume ve üç source mevcut; `K8S_APISERVER_MISSING` korundu; semantic verifier ve 9/9 SHA replay geçti | `p0-env/artifacts/P2-MINIKUBE-STATE-POSTMORTEM-001/ob-minikube-state-postmortem-001/` | D-075 provenance'ı kapandı; stopped state tek kök neden sağlamaz. Profile/bootstrap/application/replacement/fault yetkisi yok; D-067 değişmez |
| P2-MINIKUBE-STATE-POSTMORTEM-TOOLING-001 | 2026-08-29 | completed | Docker-off preflight'ında PowerShell 5.1 native stderr taksonomisini runtime-bağımsız yapmak | D-077 tooling; canlı diagnostic/artifact yok | Native stdout/stderr/exit-code isolation; success-with-stderr ve nonzero-with-stderr fixtures; D-076 preflight/inspect/log capture binding | İlk çağrı artifact-free `NativeCommandError` ile durdu; ID tüketilmedi. Ortak capture helper ve iki-runtime contract testleri eklendi | `p0-env/scripts/native-command-capture.ps1` | D-076 kimliği/koşulları değişmez; merge ve Docker readiness sonrası aynı preregistered runtime ayrıca yürütülür |
| P2-KUBERNETES-BOOTSTRAP-OBS-DIAG-001 / ob-k8s-bootstrap-observe-001 | 2026-08-29 | valid | D-076'nın stopped-state sınırı sonrasında bootstrap sırasında canlı process/journal kanıtı toplamak | D-079 operational diagnostic; dataset/headroom dışı; application/workload/fault yok | Preserved stopped profile; unchanged v1.34.0/4 CPU/6144 MiB/32 GiB/containerd; 58 samples; live kubelet/containerd; stop/host/verifier/seal | `K8S_APISERVER_MISSING`; kubelet missing `/etc/kubernetes/bootstrap-kubelet.conf` ile restart, control-plane container yok; host 0/0/0; semantic verifier ve 13/13 SHA replay geçti | `p0-env/artifacts/P2-KUBERNETES-BOOTSTRAP-OBS-DIAG-001/ob-k8s-bootstrap-observe-001/` | Yakın mekanizma tek kök neden değildir; `start_exit_code=null` ve CRI help output tooling sınırlamalarıdır; D-067 15u 2/3, 10u 1/3 kalır; application/replacement/fault yetkisi yok |
| P2-KUBERNETES-BOOTSTRAP-OBS-TOOLING-001 | 2026-08-29 | completed | D-079 non-interactive entrypoint null-reference kusurunu düzeltmek | D-080 tooling; runtime artifact/Minikube başlangıcı yok | Mandatory ExecutionApproved + ConfirmImpact Low + WhatIf; diğer D-079 koşulları aynı | İlk çağrı artifact öncesi durdu; ID tüketilmedi. Static ve subprocess dry-run regresyonu hazırlanır | `p0-env/scripts/run-kubernetes-bootstrap-observability-diagnostic.ps1` | Merge sonrası aynı D-079 kimliği yürütülebilir; bilimsel/runtime kapsamı genişlemez |
| P2-KUBERNETES-BOOTSTRAP-STATE-CONSISTENCY-DIAG-001 / ob-k8s-bootstrap-state-consistency-001 | 2026-08-29 | invalid | D-079 restart dalındaki kısmi existing-config state'ini ve iki tooling boşluğunu prospektif sınamak | Invalid/incomplete D-081 operasyonel tanı; dataset/headroom dışı; application/workload/fault yok | Canonical `934ca07`; preserved stopped profile; unchanged v1.34.0/4 CPU/6144 MiB/32 GiB/containerd/420/5 | İlk live inspect parse beklenen `State` alanını üretmedi; state snapshot/assessment oluşmadı. İlk seal dosya kilidinde durdu; process kapanınca 7/7 replay geçti; profile stopped, host 0/0/0 | `p0-env/artifacts/P2-KUBERNETES-BOOTSTRAP-STATE-CONSISTENCY-DIAG-001/ob-k8s-bootstrap-state-consistency-001-report.md` | ID yeniden kullanılamaz; state-consistency sorusu açık, D-067 15u 2/3 ve 10u 1/3; replacement ayrı karar/onay ister |
| P2-KUBERNETES-BOOTSTRAP-STATE-CONSISTENCY-DIAG-001 / ob-k8s-bootstrap-state-consistency-002 | 2026-08-29 | invalid | Invalid `001`in inspect-shape ve redirect kapanış boşluklarını aynı koşullarda kapatmak | D-082 invalid/incomplete operational replacement; dataset/headroom dışı | Canonical `79e7914`; unchanged preserved profile/v1.34.0/4 CPU/6144 MiB/32 GiB/containerd/420/5; 77 observations; start exit 105; live container | CRI list capture geçti; K8S_APISERVER_MISSING ve missing bootstrap-kubelet.conf tekrarlandı. İki state capture `exit_code=2`, empty stdout; verifier capture başarısını denetlemedi ve `R` alias çakışması runner çıktısında hata üretti | `p0-env/artifacts/P2-KUBERNETES-BOOTSTRAP-STATE-CONSISTENCY-DIAG-001/ob-k8s-bootstrap-state-consistency-002-report.md` | ID kapalı; profile/container stopped, OOMKilled=false, host 0/0/0, 17/17 replay; state-consistency sorusu ve kök neden açık; D-067 değişmez |
| P2-KUBERNETES-BOOTSTRAP-STATE-CONSISTENCY-TOOLING-002 | 2026-08-31 | completed | D-082 shell argument fragmentation ve false-positive verifier kusurlarını runtime olmadan kapatmak | D-083 offline tooling; dataset/headroom dışı | Windows argument escaping; runner capture exit/stdout/path assertions; alias-safe verifier; sealed-invalid negative ve synthetic-valid positive fixture | PowerShell 5.1/7 native argument testleri ile runtime/verifier/contract regresyonları geçti | `p0-env/scripts/test-bootstrap-state-consistency-verifier.ps1` | `001`/`002` değişmez; yeni diagnostic ID ve runtime ayrı onay/karar gerektirir |
| P2-KUBERNETES-BOOTSTRAP-STATE-CONSISTENCY-DIAG-001 / ob-k8s-bootstrap-state-consistency-003 | 2026-08-31 | valid | D-083 sonrası state-consistency sorusunu aynı koşullarda yeniden test etmek | D-084 completed operational diagnostic; dataset/headroom dışı | Canonical `168bff3`; preserved profile; v1.34.0/4 CPU/6144 MiB/32 GiB/containerd/420/5; 79 samples; start exit 105 | İki boundary'de flags/config/etcd ve aynı hashli kubeadm YAML'lar present; bootstrap/kubelet conf ile apiserver/etcd manifestleri missing. Existing-config restart + no reconfiguration; CRI empty; 470 kubelet missing-file kaydı; K8S_APISERVER_MISSING | `p0-env/artifacts/P2-KUBERNETES-BOOTSTRAP-STATE-CONSISTENCY-DIAG-001/ob-k8s-bootstrap-state-consistency-003-report.md` | ID kapalı; profile/container stopped, OOMKilled=false, host 0/0/0, verifier ve 17/17 replay; partial-state kanıtı tek kök neden değildir; D-067 değişmez |
| P2-KUBERNETES-BOOTSTRAP-DIAG-001 / ob-k8s-bootstrap-recovery-001 | 2026-08-31 | valid | D-084 partial existing-state sonrasında clean reconstruction recoverability sınamak | D-085 completed operational diagnostic; dataset/headroom dışı | Canonical `82f7faf`; exact delete/yokluk; v1.34.0/4 CPU/6144 MiB/32 GiB/containerd; 180/5 | Clean bootstrap; 31/31 healthy; 1 Ready node; 8/8 kube-system Running | `p0-env/artifacts/P2-KUBERNETES-BOOTSTRAP-DIAG-001/ob-k8s-bootstrap-recovery-001-report.md` | ID kapalı; stopped, exit 130, OOMKilled=false, host 0/0/0, verifier ve 12/12 replay; origin/unique cause kanıtlanmaz; D-067 değişmez |
| P2-NETWORK-DELAY-BASE-READINESS-DIAG-001 / ob-network-base-readiness-004 | 2026-08-31 | invalid | D-085 sonrası eksik recommendationservice application readiness/stability gözlemini toplamak | D-086 invalid/incomplete operational preflight; dataset/headroom dışı | Canonical `64bfad6`; değişmeyen base + 10u; overlay/toxic/fault yok; 900/5 + 180/5 planı | Kubernetes başladı; ignored worktree-local upstream source eksikliğiyle base apply başarısız. Application/workload/readiness başlamadı; stopped, exit 130/OOM false, host 0/0/0, 4-file replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-BASE-READINESS-DIAG-001/ob-network-base-readiness-004-report.md` | ID kapalı; application sonucu yok; D-067 15u 2/3, 10u 1/3 kalır |
| P2-NETWORK-DELAY-BASE-READINESS-DIAG-001 / ob-network-base-readiness-005 | 2026-09-01 | invalid | `004` source-preflight invalidliğini aynı application sözleşmesiyle telafi etmek | D-087 invalid/incomplete operational preflight; dataset/headroom dışı | Canonical `8c37880`; exact source `5b3a712...`; base + 10u; 900/5 + 180/5 planı | Source, Kubernetes ve base apply geçti; ilk snapshot absent `containerID` direct StrictMode erişiminde durdu. Observation yok; stopped, exit 130/OOM false, host 0/0/0, 4-file replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-BASE-READINESS-DIAG-001/ob-network-base-readiness-005-report.md` | ID kapalı; application sonucu yok; D-067 değişmez |
| P2-NETWORK-DELAY-BASE-READINESS-DIAG-001 / ob-network-base-readiness-006 | 2026-09-01 | invalid | `005` optional early-pod field tooling invalidliğini aynı application sözleşmesiyle telafi etmek | D-088 invalid/incomplete verifier closure; dataset/headroom dışı | Canonical `fc180c8`; exact source; base + 10u; 900/5 + 180/5 | Availability, 60 observation, 32 stability, tek UID/restart 0/all Ready/no bad state ve supported assessment; semantic verifier `$Host` çakışmasında durdu, child exit yutuldu; stop/host/13-file replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-BASE-READINESS-DIAG-001/ob-network-base-readiness-006-report.md` | ID kapalı; assessment tanısal, valid değil; D-067 değişmez |
| P2-NETWORK-DELAY-BASE-READINESS-DIAG-001 / ob-network-base-readiness-007 | 2026-09-01 | valid | `006` semantic-verifier closure invalidliğini aynı application sözleşmesiyle telafi etmek | D-089/D-090 completed operational diagnostic; dataset/headroom dışı | Canonical `9c6feb9`; pinned source; base+10u; 900/5 + 180/5; alias-safe verifier/child exit gate | Availability; 40 observation; 33 stability; tek UID; restart count sabit 2; all Ready; no bad state; semantic verifier, host 0/0/0 ve 13-file replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-BASE-READINESS-DIAG-001/ob-network-base-readiness-007-report.md` | İki restart convergence öncesi/sırasında; stability'de yenisi yok. ID kapalı; D-067 değişmez; normal/fault yetkisi yok |
| P2-NETWORK-DELAY-BASE-READINESS-DIAG-001 / ob-network-base-readiness-008 | 2026-09-02 | invalid | D-094 clean reconstruction sonrası application readiness/stability durumunu yeniden doğrulamak | D-095/D-097 invalid/incomplete operational preflight; dataset/headroom dışı | Canonical `089b675`; D-096 roots/profile/source pass; unchanged base + 10u; 900/5 + 180/5 plan | Existing-profile start `IF_SSH_AUTH`; public-key authentication rejected; base/workload/observation yok; stopped exit 130/OOM false; host 0/0/0; initial 5-file + final 9-file replay | `p0-env/artifacts/P2-NETWORK-DELAY-BASE-READINESS-DIAG-001/ob-network-base-readiness-008-report.md` | ID kapalı; SSH auth yakın mekanizma, unique cause değil; D-067 15u 2/3, 10u 1/3; delete/reset/replacement/fault ayrı |
| P2-NETWORK-DELAY-BASE-READINESS-TOOLING-001 | 2026-09-02 | completed | D-095 clean-code ile D-094 checkout-local runtime state/source provenance çatışmasını kapatmak | D-096 repository-only portability tooling; runtime/artifact yok | Explicit mandatory roots; absolute resolved paths; D-094 profile config + stopped exit 130/OOM false + volume + pinned source preflight; manifest/verifier binding | PS5.1/7 contract ve verifier fixture testleri | `p0-env/scripts/run-network-base-readiness-diagnostic.ps1` | `008` tüketilmedi; D-095 koşulları ve D-067 değişmez; merge/runtime ayrı |
| P2-NETWORK-DELAY-BASE-READINESS-DIAG-001 / ob-network-base-readiness-009 | 2026-09-03 | invalid | D-097 SSH mismatch sonrası application readiness/stability doğrulaması | D-098/D-099 invalid/incomplete operational diagnostic; dataset/headroom dışı | Canonical `39f00a9`; matching 44eb runtime/source/key; base+10u planı | Start geçti; overlay checkout-relative eksik source yolunda `base_apply_failed`. Workload/observation yok; stopped exit 130/OOM false; host 0/0/0; 6-file replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-BASE-READINESS-DIAG-001/ob-network-base-readiness-009-report.md` | ID kapalı; D-067 değişmez; retry/fault yetkisi yok |
| P2-NETWORK-DELAY-BASE-READINESS-DIAG-001 / ob-network-base-readiness-010 | 2026-09-03 | invalid | `009` source-binding invalidliğini değişmeyen application sözleşmesiyle telafi etmek | D-099/D-100 invalid/incomplete operational diagnostic; dataset/headroom dışı | Canonical `8e15ef1`; source-bound base+10u; 900/5+180/5; no fault | Source/apply geçti; availability true; 33 stability örneğinde restart 1..5, Ready 1, bad-state 18. Empty log capture null contents ile assessment öncesi durdu; stopped exit 137/OOM false, host 0/0/0, 13-file replay | `p0-env/artifacts/P2-NETWORK-DELAY-BASE-READINESS-DIAG-001/ob-network-base-readiness-010-report.md` | ID kapalı; observation olumsuz fakat valid assessment değil; D-067 değişmez |
| P2-NETWORK-DELAY-BASE-READINESS-DIAG-001 / ob-network-base-readiness-011 | 2026-09-03 | valid | `010` null evidence-capture invalidliğini aynı sözleşmeyle telafi etmek | D-100/D-101 completed operational diagnostic; dataset/headroom dışı | Canonical `5bac21a`; null-safe capture; source-bound base+10u; 900/5+180/5; no fault | Availability true; 34 stability örneği; tek UID; restart sabit 6; Ready 34/34; bad state yok; zero-byte previous log; semantic verifier, host 0/0/0, stopped exit 137/OOM false ve 16-file replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-BASE-READINESS-DIAG-001/ob-network-base-readiness-011-report.md` | ID kapalı; D-067 değişmez; normal/fault yetkisi yok |
| P1-HOST-NETWORK-PORTABILITY-001 / ob-host-network-portability-wifi-001 | 2026-09-04 | invalid/incomplete | Exact Wi-Fi adaptörü+sürücüsünün mevcut host-stability sözleşmesini destekleyip desteklemediğini sınamak | D-102–D-106 Dataset-dışı no-fault qualification | Clean boot geçti; 2x1800 sn aktif yük + 600 sn E2E; üç ayrı UID; Wi-Fi bağlamı kararlı; her pencerede RecordId host 0/0/0 | `archive_raw_logs`, PowerShell pipeline sonrası güvenilmez `$LASTEXITCODE` nedeniyle çalışan profili stopped sınıflandırdı; application telemetry closure geçmedi. 8 dosyalık seal replay geçti; profile final durumda stopped | `p0-env/artifacts/P1-HOST-NETWORK-PORTABILITY-001/ob-host-network-portability-wifi-001/` | ID tüketildi; başarı/qualification iddiası yok; aynı ID tekrar edilmez; Dataset/D-067 sayımına girmez |
| P1-HOST-NETWORK-PORTABILITY-001 / ob-host-network-portability-wifi-002 | 2026-09-05 | invalid/incomplete | D-106 teknik delta ile exact Wi-Fi adaptörü+sürücüsü portability qualification | D-107–D-108 Dataset-dışı no-fault replacement | Clean boot geçti; 2x1800 sn + 600 sn; üç UID; Wi-Fi bağlamı kararlı; her pencerede host 0/0/0 | Close alt süreci explicit external `MINIKUBE_HOME` değerini repository-local varsayılanla ezdi; yanlış profile store nedeniyle `archive_raw_logs` failed. 8-file seal replay geçti; final profile stopped. Stop sonrasında aynı Wi-Fi PCIe parent üzerinde 12 WHEA-17 oluştu | `p0-env/artifacts/P1-HOST-NETWORK-PORTABILITY-001/ob-host-network-portability-wifi-002/` | ID tüketildi; qualification iddiası yok; aynı ID tekrar edilmez; Dataset/D-067 sayımına girmez |
| D-109 / Wi-Fi host-remediation inventory | 2026-09-06 | complete / runtime-blocking | Tekrarlanan Wi-Fi PCIe WHEA-17 sinyalinde resmî remediation adayı var mı? | Salt-okunur model/BIOS/driver/power inventory + resmî ASUS karşılaştırması | WLAN 3.0.1.1314 ve chipset 10.1.31.2 resmî paketlerle eşleşiyor; BIOS 311, görünen destek BIOS 310; AC ASPM off | Güvenli resmî update adayı doğrulanmadı; ASUS/yetkili servis remediasyonuna kadar uzun Wi-Fi runtime bloke | `p0-env/artifacts/P1-HOST-NETWORK-PORTABILITY-001/d109-host-remediation-inventory.md` | Ayar değişmedi; seri/ağ kimliği yok; Dataset/D-067 değişmedi |
...
| Modaliteler hizalı mı? | Kabul edilebilir missingness ve timestamp uyumu | 22/22 geçerli run (21 P1 CPU + 1 P2 network-delay) archive/run-ID/UTC/schema-v3/receipt replay geçti; feature-window missingness raporu yok | Archive katmanı geçti; feature katmanı açık |
