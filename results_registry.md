...
| P1-CPU-001 / ob-cpu-low-005 | 2026-08-04 | planned | İlk geçerli düşük CPU sonucunun bağımsız tekrarını toplamak | `cpu-recommendation-low-v2`; `p1-cpu-001-slo-v1`; seed 1 | 004 ile koşullar değişmeden ayrı lifecycle ve artifact | Bekleniyor; run henüz başlatılmadı | `p0-env/artifacts/P1-CPU-LOW-PREREG-001/attempt-005.md` | Ayrı host, telemetry, final receipt ve offline verifier kapıları zorunlu |
| P1-CPU-001 / ob-cpu-low-006 | 2026-08-04 | planned | İlk geçerli düşük CPU sonucunun ikinci bağımsız tekrarını toplamak | `cpu-recommendation-low-v2`; `p1-cpu-001-slo-v1`; seed 1 | 004/005 ile koşullar değişmeden yeni canonical revision ve artifact | Bekleniyor; 005 kapanmadan başlatılmaz | `p0-env/artifacts/P1-CPU-LOW-PREREG-001/attempt-006.md` | 005 sonucu severity veya SLO'yu değiştirmek için kullanılmaz; bağımsız kapılar yeniden uygulanır |
