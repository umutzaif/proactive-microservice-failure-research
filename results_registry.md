...
| P1-HOST-NETWORK-PORTABILITY-001 / ob-host-network-portability-wifi-001 | - | planned | Exact Wi-Fi adaptörü+sürücüsünün mevcut host-stability sözleşmesini destekleyip desteklemediğini sınamak | D-102–D-105 Dataset-dışı no-fault qualification; runtime yetkisiz | Clean boot/15 GiB/Docker/stopped-profile/pinned-source preflight; 2 bağımsız 30 dk aktif yük + 1 adet 10 dk E2E; üç UID; pencere başına RecordId host 0/0/0; privacy-safe context | D-104 numeric Wi-Fi medium düzeltmesi geçti; sonraki preflight D-105 PS5.1 bitişik throw tokenını artifact/cluster öncesi buldu; bütün runner/verifier throw biçimleri ve negatif contract düzeltildi; canlı kanıt yok | `p0-env/artifacts/P1-HOST-NETWORK-PORTABILITY-001/ob-host-network-portability-wifi-001-preregistration.md` | ID tüketilmedi; merge/runtime ayrıdır; Dataset/D-067 sayımına girmez |
