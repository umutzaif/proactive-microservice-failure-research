...
| P2-NETWORK-DELAY-001 / ob-netdelay-15u-001 | - | planned | İlk kademeli network-delay bilimsel gözlemini toplamak | Yürütülmedi; dataset örneği yok | D-043 dondurulmuş profil | Bekleniyor | `p0-env/artifacts/P2-NETWORK-DELAY-001/ob-netdelay-15u-001-preregistration.md` | Canonical merge + açık kullanıcı onayı + bütün fresh kapılar olmadan fault başlatılmaz |
