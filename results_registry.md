...
| P1-CPU-001 / ob-cpu-high-001 | 2026-08-07 | planned | İlk yüksek şiddetli CPU kalibrasyonunu toplamak | `cpu-recommendation-high-v1`; 150m; min +75m; aynı workload/seed/SLO | 5 dk warm-up + 5 dk baseline + 120 sn ramp + 300 sn steady + 5 dk cooldown; coverage 48/60 | Profil/tooling merge, temiz preflight ve ayrı yürütme onayı bekleniyor | `p0-env/artifacts/P1-CPU-HIGH-PREREG-001/attempt-001.md` | İlk high calibration; null geçerli olabilir, workload/service/SLO otomatik değişmez |
