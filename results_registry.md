...
|---|---|---|---|---|---|---|---|---|
| P2-NETWORK-DELAY-HEADROOM-001 / ob-netdelay-500m-normal-10u-006 | 2026-09-09 | planned | D-113 Ethernet replacement; D-112 politika ve ortam notu | Henüz veri yok | 10/1/1, no-toxic, 500m/100m/100m; D-111 yakınsama | Runtime başlamadı; D-067 10u 1/3, 15u 2/3 | `p0-env/artifacts/P2-NETWORK-DELAY-HEADROOM-001/ob-netdelay-500m-normal-10u-006-preregistration.md` | Tek manuel run, no-retry; 005 kapalı, 003 final; runtime ayrı onaylı |
