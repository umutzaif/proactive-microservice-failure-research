...
| P1-HOST-NETWORK-PORTABILITY-001 / ob-host-network-portability-wifi-002 | - | planned | D-106 teknik delta ile exact Wi-Fi adaptörü+sürücüsü portability qualification | D-107 Dataset-dışı no-fault replacement; runtime yetkisiz | D-102 koşulları değişmedi: 2x1800 sn + 600 sn, üç UID, sabit Wi-Fi bağlamı, pencere başına host 0/0/0, tam telemetry close ve offline receipt | Canlı kanıt yok | `p0-env/artifacts/P1-HOST-NETWORK-PORTABILITY-001/ob-host-network-portability-wifi-002-preregistration.md` | Canonical merge ve ayrıca açık runtime onayı gerekir; Dataset/D-067 sayımına girmez |
