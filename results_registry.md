...
| P2-NETWORK-DELAY-RESOURCE-COMPAT-REPLACEMENT-004 / ob-network-resource-compat-005 | 2026-08-20 | planned | D-054 run-manifest provenance kapısıyla D-050'yi değişmeden yeniden yürütmek | Tooling/preregistration; dataset/modeling dışı; fault yok | 500m ve bütün D-050 kapıları + expected/folder/manifest ID eşleşmesi | Provenance fixture positive 1/negative 2; runner/verifier/design contract testleri; canlı run yok | `p0-env/artifacts/P2-NETWORK-DELAY-RESOURCE-COMPAT-001/ob-network-resource-compat-005-preregistration.md` | Canonical merge + ayrı runtime onayı gerekir; `001`-`004` invalid kalır |
