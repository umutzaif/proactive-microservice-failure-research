...
| P2-NETWORK-DELAY-HEADROOM-001 / ob-netdelay-500m-normal-15u-001 | 2026-08-21 | planned | D-067 randomize sıranın ilk 15u no-toxic proxy normalini toplamak | Preregistered normal; fault yok | 15u/rate1/seed1; 500m/100m/100m; no-toxic; 120s stability; 300/300; 60/48; null SLO; pod/host/schema-v3/rollback/receipt | Tooling fixture ve WhatIf no-mutation geçti; canlı sonuç yok | `p0-env/config/analysis/network-delay-headroom-decision-inputs-v1.json` | Bu aşama için kullanıcı runtime onayı var; invalid kanıt korunur ve ID tekrar kullanılmaz |
