...
| P2-NETWORK-DELAY-REPLACEMENT-PREREG-005 / ob-netdelay-15u-006 | 2026-08-20 | planned | D-055 ile valid 500m compatibility tasarımını frozen scientific lifecycle'a taşımak | Tooling/preregistration; dataset değil; fault yok | 500m/100m + değişmeyen 15/1/1, ramp, lifecycle, effect/SLO/schema-v3/receipt | Runner resource/RecordId/native-JSON/run-manifest contract testleri; canlı run yok | `p0-env/artifacts/P2-NETWORK-DELAY-001/ob-netdelay-15u-006-preregistration.md` | Canonical merge + ayrı runtime onayı gerekir; `005` invalid kalır |
