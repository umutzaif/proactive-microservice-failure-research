...
| P2-KUBERNETES-BOOTSTRAP-DIAG-001 / ob-k8s-bootstrap-001 | 2026-08-28 | planned | `002` öncesi stale Minikube persistent-state hipotezini temiz bootstrap ile sınamak | Operasyonel altyapı tanısı; dataset/headroom dışı; application/workload/toxic/fault yok | Eski container/volume/log kanıtı; exact-profile delete ve yokluk doğrulaması; değişmeyen v1.34.0/4 CPU/6144 MiB/32 GiB/containerd; 180/5 system stability; host/seal/replay | Contract/verifier/WhatIf ve clean Git canlıdan önce zorunlu | `p0-env/artifacts/P2-KUBERNETES-BOOTSTRAP-DIAG-001/ob-k8s-bootstrap-001-preregistration.md` | Başarı stale state'i tek başına kesin neden yapmaz; application veya replacement normal run yetkisi değildir |
