...
| P2-NETWORK-DELAY-PROBE-RESOURCE-DIAG-001 / ob-network-probe-resource-001 | 2026-08-15 | planned | O-019 probe timeout ile CPU/throttling/memory/OOM/pressure zaman bağını faultsuz ölçmek | Diagnostic; dataset/modeling dışı; toxic/fault yok | 180 sn / 5 sn; cAdvisor Prometheus serileri + pod/event/log/node/rollback/host | Ön-kayıt ve contract testi | `p0-env/artifacts/P2-NETWORK-DELAY-PROBE-RESOURCE-DIAG-001/preregistration.md` | Nedensellik iddiası yok; probe/resource/replacement değişikliği sonuçtan önce yasak |
