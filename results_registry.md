...
| P1-CPU-001 / ob-cpu-low-008 | 2026-08-06 | planned | Platform-independent worker hash sözleşmesiyle düşük CPU tekrarını toplamak | `cpu-recommendation-low-v4`; diğer koşullar değişmez | UTF-8/LF canonical worker hash; worker UTC + wall/monotonic süre; yeni run ID ve artifact | Bekleniyor; v4 merge ve temiz canlı preflight öncesi başlatılamaz | `p0-env/artifacts/P1-CPU-LOW-PREREG-001/attempt-008.md` | 007 invalid kalır; hash kontrolü kaldırılmaz ve severity/SLO değiştirilmez |
