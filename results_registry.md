...
| P2-NETWORK-DELAY-HEADROOM-001 / ob-netdelay-500m-normal-10u-004 | 2026-09-01 | planned | D-091 ile invalid `10u-002` yuvasını aynı D-067 koşullarında telafi etmek | Repository-only preregistration; no-fault runtime yetkisiz | 10u/rate1/seed1; 500m/100m/100m; no-toxic; 120s stability; 300/300; 60/48; null SLO; lifecycle/telemetry/host/rollback/receipt | Statik sıra, allowlist ve aktif run bağları hazırlanır; canlı kanıt yok | `p0-env/artifacts/P2-NETWORK-DELAY-HEADROOM-001/ob-netdelay-500m-normal-10u-004-preregistration.md` | `10u-003` son slot kalır; merge runtime/fault yetkisi değildir |
