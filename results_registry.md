...
| P1-CPU-001 / ob-cpu-medium-002 | 2026-08-06 | planned | İlk geçerli medium sonucunun bağımsız tekrarını toplamak | `cpu-recommendation-medium-v1`; koşullar 001 ile değişmez | Ayrı canonical revision, run ID, artifact, host ve receipt zinciri | Merge, temiz preflight ve ayrı yürütme onayı bekleniyor | `p0-env/artifacts/P1-CPU-MEDIUM-PREREG-001/attempt-002.md` | İlk medium tekrar; sonuç görülmeden eşikler değiştirilemez |
| P1-CPU-001 / ob-cpu-medium-003 | 2026-08-06 | planned | İlk geçerli medium sonucunun ikinci bağımsız tekrarını toplamak | `cpu-recommendation-medium-v1`; koşullar 001/002 ile değişmez | Ayrı canonical revision, run ID, artifact, host ve receipt zinciri | 002 sonucu otomatik yürütme yetkisi vermez; kendi kapıları ve onayı beklenir | `p0-env/artifacts/P1-CPU-MEDIUM-PREREG-001/attempt-003.md` | Üç geçerli medium aday oluşmadan tekrarlanabilirlik özeti dondurulmaz |
