...
| P2-NETWORK-DELAY-REPEATABILITY-001 / ob-netdelay-15u-repeat-001 | 2026-08-21 | planned | D-059 ile ilk randomize fault slotunu değişmeyen `008` koşullarında toplamak | Preregistered fault slotu; henüz canlı run yok | 15/1/1; 500m/100m; D-038; 300/300/120/300/300; 0->750 ms; effect >=500 ms | Active run-ID/profile/runner/toxic binding, portability replay, prereg contract | `p0-env/artifacts/P2-NETWORK-DELAY-REPEATABILITY-001/ob-netdelay-15u-repeat-001-preregistration.md` | Merge + ayrı runtime onayı gerekir; tek run blok/tekrarlanabilirlik kapanışı değildir |
