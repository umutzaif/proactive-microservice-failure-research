...
| P1-CPU-001 / ob-cpu-low-007 | 2026-08-06 | planned | Geçersiz 006 yerine worker-emitted UTC ile yeni düşük CPU tekrarını toplamak | `cpu-recommendation-low-v3`; `p1-cpu-001-slo-v1`; seed 1 | Şiddet/lifecycle süreleri değişmez; worker UTC fault sınırı, outer exec UTC tanısal kanıt; iki süre kapısı | Bekleniyor; düzeltme merge ve temiz canonical preflight öncesi başlatılamaz | `p0-env/artifacts/P1-CPU-LOW-PREREG-001/attempt-007.md` | 006 invalid kalır; 007 yeni run ID ve artifact ile bağımsız kapanacaktır |
