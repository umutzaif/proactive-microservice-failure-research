...
| P1-CPU-001 / ob-cpu-low-009 | 2026-08-06 | planned | Aynı v4 koşullarını açık event-array dönüşümüyle tekrarlamak | `cpu-recommendation-low-v4`; diğer koşullar değişmez | Injector `Generic.List.ToArray()`; canlı-şekilli bağımsız fixture; yeni run ID/artifact | Bekleniyor; düzeltme merge ve temiz preflight öncesi başlamaz | `p0-env/artifacts/P1-CPU-LOW-PREREG-001/attempt-009.md` | 008 invalid kalır; severity, SLO, hash ve süre sözleşmesi değişmez |
