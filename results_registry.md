...
| P2-NETWORK-DELAY-RESOURCE-COMPAT-REPLACEMENT-001 / ob-network-resource-compat-002 | 2026-08-20 | planned | D-051 JSON kanal ayrımıyla D-050 koşullarını değişmeden yeniden yürütmek | Tooling/preregistration; dataset/modeling dışı; fault yok | 500m ve bütün D-050 stability/resource/host/rollback/seal eşikleri aynı | Direct-kubectl stdout JSON contract ve stderr-merge-negative runner testi geçti; canlı run yok | `p0-env/scripts/run-network-resource-compatibility.ps1` | Canonical merge + ayrı runtime onayı gerekir; `001` invalid kalır |
