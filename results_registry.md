...
| P2-NETWORK-DELAY-RESOURCE-COMPAT-REPLACEMENT-003 / ob-network-resource-compat-004 | 2026-08-20 | planned | D-053 `$Args` otomatik değişken çakışmasını kaldırarak D-050'yi değişmeden yeniden yürütmek | Tooling/preregistration; dataset/modeling dışı; fault yok | 500m ve bütün D-050 stability/resource/host/rollback/seal eşikleri aynı | Runner testi `$Args` parametresini yasaklar, `$KubectlArguments` dizi aktarımını ve D-052 native kanal testini doğrular; canlı run yok | `p0-env/artifacts/P2-NETWORK-DELAY-RESOURCE-COMPAT-001/ob-network-resource-compat-004-preregistration.md` | Canonical merge + ayrı runtime onayı gerekir; `001/002/003` invalid kalır |
