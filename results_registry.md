...
| P2-NETWORK-DELAY-HEADROOM-001 / ob-netdelay-500m-normal-15u-006 | 2026-08-21 | planned | D-070 ile invalid ilk slotu açık seed provenance ile aynı koşullarda telafi etmek | Preregistered normal; fault yok | 15u/rate1/seed1; 500m/100m/100m; no-toxic; 120s stability; 300/300; 60/48; null SLO; pod/host/schema-v3/rollback/receipt | Metadata top-level seed + verifier, finalizer receipt entegrasyonu, çapraz ID, parse/no-fault ve WhatIf canlıdan önce zorunlu | `p0-env/config/analysis/network-delay-headroom-decision-inputs-v1.json` | Yalnız tüm close gate'ler geçerse ilk geçerli 15u tekrar olur |
