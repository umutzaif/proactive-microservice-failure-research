...
| P2-NETWORK-DELAY-BASE-READINESS-DIAG-001 / ob-network-base-readiness-011 | 2026-09-03 | planned | `010` null evidence-capture invalidliğini aynı sözleşmeyle telafi etmek | D-100 preregistered operational diagnostic; dataset/headroom dışı; runtime yetkisiz | Null-safe string-array capture; zero-byte empty evidence; source-bound base+10u; 900/5+180/5; no fault | Repository hazırlığı; canlı `011` yok | `p0-env/artifacts/P2-NETWORK-DELAY-BASE-READINESS-DIAG-001/ob-network-base-readiness-011-preregistration.md` | Merge ve ayrı runtime onayı gerekir; D-067 değişmez |
