...
| P2-NETWORK-DELAY-BASE-READINESS-DIAG-001 / ob-network-base-readiness-009 | 2026-09-03 | planned | D-097 SSH-key mismatch sonrası application readiness/stability sorusunu aynı D-095 koşullarında yeniden sınamak | D-098 preregistered operational diagnostic; dataset/headroom dışı; runtime yetkisiz | Explicit matching runtime/source roots; public key hash/fingerprint + container authorized_keys equality; unchanged base+10u, 900/5+180/5, no fault; captured start/host/stop/verifier/seal | Repository hazırlığı; canlı `009` yok | `p0-env/artifacts/P2-NETWORK-DELAY-BASE-READINESS-DIAG-001/ob-network-base-readiness-009-preregistration.md` | Merge ve ayrı runtime onayı gerekir; private key kaydedilmez; D-067 15u 2/3, 10u 1/3; replacement/fault yetkisi yok |
