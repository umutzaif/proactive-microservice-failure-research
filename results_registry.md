...
| P2-NETWORK-DELAY-DESIGN-001 | 2026-08-15 | planned | Kademeli network delay için hedef, izolasyon, fiziksel etki ve SLO karar desteği | Tooling/preregistration; dataset değil; fault yok | İki workload sealed normal trace analizi; netem/proxy/mesh güvenlik ve cleanup karşılaştırması | Bekleniyor; mevcut repo NET_ADMIN/netem injector içermez | `p0-env/artifacts/P2-NETWORK-DELAY-DESIGN-001/preregistration.md` | Tasarım ve tooling merge edilmeden bilimsel run ID/fault yok |
