...
| P1-CPU-001 / ob-cpu-high-002 | 2026-08-07 | planned | İlk geçerli high sonucunun bağımsız tekrarını toplamak | `cpu-recommendation-high-v1`; koşullar 001 ile değişmez | Ayrı canonical revision, run ID, artifact, host ve receipt zinciri | Hazırlık PR merge ve temiz preflight bekleniyor; yürütme D-029 onayı kapsamında | `p0-env/artifacts/P1-CPU-HIGH-PREREG-001/attempt-002.md` | İlk high tekrar; sonuç görülmeden eşik/SLO değiştirilemez |
| P1-CPU-001 / ob-cpu-high-003 | 2026-08-07 | planned | İlk geçerli high sonucunun ikinci bağımsız tekrarını toplamak | `cpu-recommendation-high-v1`; koşullar 001/002 ile değişmez | Ayrı canonical revision, run ID, artifact, host ve receipt zinciri | 002 tamamlanınca kendi temiz preflight'ıyla yürütülür; yeniden onay gerekmez | `p0-env/artifacts/P1-CPU-HIGH-PREREG-001/attempt-003.md` | Üç geçerli high aday oluşmadan tekrarlanabilirlik özeti dondurulmaz |
