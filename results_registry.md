...
| P2-KUBERNETES-BOOTSTRAP-OBS-DIAG-001 / ob-k8s-bootstrap-observe-001 | 2026-08-29 | planned | D-076'nın stopped-state sınırı sonrasında bootstrap sırasında canlı process/journal kanıtı toplamak | D-079 operational preregistration; dataset/headroom dışı; application/workload/fault yok | Preserved stopped profile; unchanged v1.34.0/4 CPU/6144 MiB/32 GiB/containerd; 420/5 process samples; live kubelet/containerd/CRI; stop/host/verifier/seal | Canlı execution yok; exact stopped-container, clean Git/output absence, Docker readiness ve forbidden-scope contract kapıları hazırlandı | `p0-env/artifacts/P2-KUBERNETES-BOOTSTRAP-OBS-DIAG-001/ob-k8s-bootstrap-observe-001-preregistration.md` | Merge ve ayrı runtime onayı gerekir; başarı bile application/replacement/fault yetkisi vermez; D-067 değişmez |
