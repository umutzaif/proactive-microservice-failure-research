...
| P2-KUBERNETES-BOOTSTRAP-STATE-CONSISTENCY-DIAG-001 / ob-k8s-bootstrap-state-consistency-001 | 2026-08-29 | planned | D-079 restart dalındaki kısmi existing-config state'ini ve iki tooling boşluğunu prospektif sınamak | D-081 operasyonel ön-kayıt; dataset/headroom dışı; application/workload/fault yok | Preserved stopped profile; unchanged v1.34.0/4 CPU/6144 MiB/32 GiB/containerd/420/5; state markers; non-null exit; exact CRI | Canlı execution yok; runner/verifier/contract ve preregistration hazırlanır | `p0-env/artifacts/P2-KUBERNETES-BOOTSTRAP-STATE-CONSISTENCY-DIAG-001/ob-k8s-bootstrap-state-consistency-001-preregistration.md` | Canonical merge ve ayrı runtime onayı gerekir; tek kök neden, D-067 veya replacement yetkisi vermez |
