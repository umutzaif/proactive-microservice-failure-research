...
| P2-NETWORK-DELAY-001 / ob-netdelay-15u-008 | 2026-08-20 | completed | D-055/D-056/D-057 altında ilk geçerli 500m network-delay bilimsel run'ını toplamak | Dataset adayı; network-delay fault | 15/1/1; D-038; 300/300/120/300/300; 0->750 ms; effect >=500 ms | D-038 25/restart 0; coverage 60/60; median 3,238->755,233 ms, effect +751,995 ms; latency manifestation 18:25:43.328Z; host 0/0/0; raw/enriched/schema-v3/final replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-001/ob-netdelay-15u-008-report.md` | İlk geçerli network-delay adayı; 5 boundary trace korunup selected dışı; pwsh7 UTC-ms portability tanısı ayrı tooling sınırı; otomatik sonraki aşama yok |
| P2-NETWORK-DELAY-REPEATABILITY-001 | 2026-08-21 | planned | D-058 shell-portability kapısını kapatıp dört randomize eşlenmiş kontrol/fault blokta run-arası varyansı ölçmek | Preregistered tekrarlanabilirlik pilotu; henüz canlı run yok | `008` set dışı pilot; seed 20260821; F-C,F-C,C-F,C-F; aynı overlay/workload/resource/lifecycle; fault >=500 ms | pwsh5.1/pwsh7 pozitif-negatif UTC fixture ve immutable `008` replay eşdeğerliği; randomization manifesti | `p0-env/artifacts/P2-NETWORK-DELAY-REPEATABILITY-001/preregistration.md` | Canonical merge + her slot için ayrı runtime onayı gerekir; dört çift sonrası örnek büyüklüğü akademik kararı |
| P2-NETWORK-DELAY-REPEATABILITY-001 / ob-netdelay-15u-repeat-001 | 2026-08-21 | completed | D-059 ile ilk randomize fault slotunu değişmeyen `008` koşullarında toplamak | Geçerli randomized fault slotu; dataset adayı | 15/1/1; 500m/100m; D-038; 300/300/120/300/300; 0->750 ms; effect >=500 ms | D-038 25/restart 0; coverage 60/60; median 5,548->755,171 ms; effect +749,623 ms; first symptom 29,397 sn; latency manifestation 104,397 sn; host 0/0/0; raw/enriched/schema-v3/final replay geçti | `p0-env/artifacts/P2-NETWORK-DELAY-REPEATABILITY-001/ob-netdelay-15u-repeat-001-report.md` | İlk blok fault slotu 1/2; sıradaki immutable slot control-001; tek başına genel tekrarlanabilirlik veya Dataset v1 geçişi değildir |
| P2-NETWORK-DELAY-CONTROL-CONTRACT-001 / ob-netdelay-15u-control-001 | 2026-08-21 | planned | D-060 ile ilk paired no-toxic kontrolün metadata ve geçerlilik semantiğini dondurmak | Contract/prereg; runner ve canlı kontrol yok | Aynı overlay/15/1/1/500m/100m/300-300-120-300-300; toxic yok; matched intervals; coverage >=48/48; null manifestation | 11-check static contract verifier; runner/analyzer/verifier sonraki pakette | `p0-env/artifacts/P2-NETWORK-DELAY-REPEATABILITY-001/ob-netdelay-15u-control-001-contract.md` | Merge canlı onay değildir; uygulama ve fixture kapısı gerekir |
