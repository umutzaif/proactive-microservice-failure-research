...
| P2-NETWORK-DELAY-BASE-READINESS-DIAG-001 / ob-network-base-readiness-006 | 2026-09-01 | planned | `005` optional early-pod field tooling invalidliğini aynı application sözleşmesiyle telafi etmek | D-088 preregistered operational replacement; dataset/headroom dışı; runtime yetkisiz | Pending/ContainerCreating optional-field fixtures; exact source; değişmeyen base + 10u, 900/5 + 180/5, no fault | Repository hazırlığı; canlı gözlem yok | `p0-env/artifacts/P2-NETWORK-DELAY-BASE-READINESS-DIAG-001/ob-network-base-readiness-006-preregistration.md` | Canonical merge ve ayrı runtime onayı gerekir; D-067 değişmez |
