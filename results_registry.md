...
| P2-NETWORK-DELAY-BASE-READINESS-DIAG-001 / ob-network-base-readiness-010 | 2026-09-03 | planned | `009` source-binding invalidliğini değişmeyen application sözleşmesiyle telafi etmek | D-099 preregistered operational diagnostic; dataset/headroom dışı; runtime yetkisiz | Source-bound temporary deployment bundle; pinned source; base+10u; 900/5+180/5; no fault; host/stop/verifier/seal | Repository hazırlığı; canlı `010` yok | `p0-env/artifacts/P2-NETWORK-DELAY-BASE-READINESS-DIAG-001/ob-network-base-readiness-010-preregistration.md` | Merge ve ayrı runtime onayı gerekir; D-067 değişmez |
