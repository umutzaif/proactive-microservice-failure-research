...
| P2-NETWORK-DELAY-BASE-READINESS-DIAG-001 / ob-network-base-readiness-005 | 2026-09-01 | planned | `004` source-preflight invalidliğini aynı application sözleşmesiyle telafi etmek | D-087 preregistered operational replacement; dataset/headroom dışı; runtime yetkisiz | Exact source HEAD `5b3a712...` pre-cluster; değişmeyen base + 10u; overlay/toxic/fault yok; 900/5 + 180/5; host/stop/verifier/seal | Repository hazırlığı; canlı gözlem yok | `p0-env/artifacts/P2-NETWORK-DELAY-BASE-READINESS-DIAG-001/ob-network-base-readiness-005-preregistration.md` | Source hazırlığı, canonical merge ve runtime ayrı onay ister; D-067 değişmez |
