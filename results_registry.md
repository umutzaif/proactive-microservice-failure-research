...
| P2-NETWORK-DELAY-HEADROOM-001 / ob-netdelay-500m-normal-15u-005 | 2026-08-21 | planned | D-069 ile invalid ilk sıra slotunu aynı dondurulmuş koşullarda yeniden telafi etmek | Preregistered normal; fault yok | 15u/rate1/seed1; 500m/100m/100m; no-toxic; 120s stability; 300/300; 60/48; null SLO; pod/host/schema-v3/rollback/receipt | Runner/verifier kalan ID çapraz sözleşmesi, ayrıntılı verifier failure çıktısı, parse/no-fault ve WhatIf canlıdan önce zorunlu | `p0-env/config/analysis/network-delay-headroom-decision-inputs-v1.json` | Yalnız tüm close gate'ler geçerse üç 15u girdisinden biri; D-067 koşulları ve kalan sıra değişmez |
