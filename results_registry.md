...
| P2-NETWORK-DELAY-BASE-READINESS-DIAG-001 / ob-network-base-readiness-002 | 2026-08-27 | planned | D-072 ile altyapı-preflight invalid `001`i aynı D-071 koşullarında telafi etmek | Operasyonel tanı; dataset/headroom dışı; toxic/fault yok | Docker ready; mevcut base + 10u; overlay yok; 900/5 convergence + Available sonrası 180/5 stability; host/seal/replay | Throw-token regression, contract/parser/WhatIf ve Docker readiness canlıdan önce zorunlu | `p0-env/artifacts/P2-NETWORK-DELAY-BASE-READINESS-DIAG-001/ob-network-base-readiness-002-preregistration.md` | Başarı replacement normal run yetkisi değildir |
