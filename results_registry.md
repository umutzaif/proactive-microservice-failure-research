...
| P2-NETWORK-DELAY-HEADROOM-001 / ob-netdelay-500m-normal-15u-004 | 2026-08-21 | planned | D-068 ile invalid ilk 15u sıra slotunu aynı koşullarda telafi etmek | Preregistered normal; fault yok | 15u/rate1/seed1; 500m/100m/100m; no-toxic; 120s stability; 300/300; 60/48; null SLO; pod/host/schema-v3/rollback/receipt | `$Host` çakışması `$hostHealth` ile düzeltilecek; parse, reserved-variable ve WhatIf kapıları canlıdan önce zorunlu | `p0-env/config/analysis/network-delay-headroom-decision-inputs-v1.json` | Yalnız geçerli kapanırsa üç 15u girdisinden biri; D-067 koşulları ve kalan sıra değişmez |
