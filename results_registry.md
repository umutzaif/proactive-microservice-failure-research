...
| P2-KUBERNETES-BOOTSTRAP-STATE-CONSISTENCY-DIAG-001 / ob-k8s-bootstrap-state-consistency-002 | 2026-08-29 | planned | Invalid `001`in inspect-shape ve redirect kapanış boşluklarını aynı koşullarda kapatmak | D-082 operational replacement preregistration; dataset/headroom dışı | Unchanged preserved profile/v1.34.0/4 CPU/6144 MiB/32 GiB/containerd/420/5; raw inspect-before-parse; process wait/refresh/dispose; exact CRI/state/host/seal | Runtime yok; inspect positive/negative ve nonzero-exit/handle-release fixture'ları geçti | `p0-env/artifacts/P2-KUBERNETES-BOOTSTRAP-STATE-CONSISTENCY-DIAG-001/ob-k8s-bootstrap-state-consistency-002-preregistration.md` | Canonical merge ve ayrı runtime onayı gerekir; `001` değişmez, D-067 değişmez |
