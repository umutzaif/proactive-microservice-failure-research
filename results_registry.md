...
| P1-HOST-NETWORK-PORTABILITY-001 / ob-host-network-portability-wifi-001 | - | planned | Exact Wi-Fi adaptörü+sürücüsünün mevcut host-stability sözleşmesini destekleyip desteklemediğini sınamak | D-102 Dataset-dışı no-fault qualification; runtime yetkisiz | 2 bağımsız 30 dk aktif yük + 1 adet 10 dk E2E; pencere başına RecordId host 0/0/0; application/telemetry closure; privacy-safe context | Repository preregistration ve fail-closed D-067 context tooling hazır; canlı kanıt yok | `p0-env/artifacts/P1-HOST-NETWORK-PORTABILITY-001/ob-host-network-portability-wifi-001-preregistration.md` | Merge runtime değildir; geçerli sonuç Wi-Fi run önkoşuludur, Dataset/D-067 sayımına girmez |
