...
| P2-NETWORK-DELAY-PROBE-RESOURCE-DIAG-001 / ob-network-probe-resource-002 | 2026-08-15 | planned | D-048 RecordId host kapısıyla O-019 eşzamanlı resource tanısını değişmeden tekrarlamak | Preregistered no-fault diagnostic; dataset/modeling dışı | Aynı no-toxic overlay, 180 sn / 5 sn, 13 cAdvisor seri; yeni WHEA 17/KP41/bugcheck kimliği 0; log reset fail-closed | Henüz yürütülmedi | `p0-env/artifacts/P2-NETWORK-DELAY-PROBE-RESOURCE-DIAG-001/ob-network-probe-resource-002-preregistration.md` | Probe/resource/eşik değişmez; restart yoksa O-019 kapanmaz; ayrı runtime kapıları gerekir |
