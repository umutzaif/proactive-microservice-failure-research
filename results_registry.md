...
| P2-NETWORK-DELAY-RESOURCE-COMPAT-REPLACEMENT-002 / ob-network-resource-compat-003 | 2026-08-20 | planned | D-052 native JSON stdout/stderr fiziksel izolasyonuyla D-050'yi değişmeden yeniden yürütmek | Tooling/preregistration; dataset/modeling dışı; fault yok | 500m ve bütün D-050 stability/resource/host/rollback/seal eşikleri aynı | Gerçek child-process fixture stdout JSON'u parse etti, stderr'i diagnosticte korudu ve nonzero exit'i reddetti; canlı run yok | `p0-env/artifacts/P2-NETWORK-DELAY-RESOURCE-COMPAT-001/ob-network-resource-compat-003-preregistration.md` | Canonical merge + ayrı runtime onayı gerekir; `001/002` invalid kalır |
