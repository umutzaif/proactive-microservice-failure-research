...
| P2-NETWORK-DELAY-HEADROOM-001 | 2026-08-21 | planned | D-061–D-063 için fault öncesi yeniden üretilebilir headroom girdilerini ve mevcut kanıt sınırını tanımlamak | Decision-support prereg; deney/analyzer/severity seçimi yok | 500m/100m; 10u+15u; ladder 25/50/100/250/500ms; frozen 594,664ms SLO; workload başına >=3 bağımsız yeni normal | 11-check static verifier; eligible 500m normal 0/3 ve 0/3; tarihsel 200m/750ms leakage ile authorization/choice negatif fixture'ları | `p0-env/artifacts/P2-NETWORK-DELAY-HEADROOM-001/preregistration.md` | Normal topology ve small-n uncertainty yöntemi akademik karar bekler; çözülmeden hesap ve canlı run yok |
