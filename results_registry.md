...
| P1-CPU-001 / ob-cpu-low-004 | 2026-08-04 | planned | Aynı v2 koşullarını canonical UTC finalization düzeltmesiyle tekrarlamak | `cpu-recommendation-low-v2`; `p1-cpu-001-slo-v1`; seed 1 | 003 ile aynı; yalnız teknik UTC üretici/verifier düzeltmesi | Bekleniyor; run henüz başlatılmadı | `p0-env/artifacts/P1-CPU-LOW-PREREG-001/attempt-004.md` | Düzeltme main'e merge edilip bağımsız test ve canlı run-ID kapıları geçmeden başlatılmaz |
