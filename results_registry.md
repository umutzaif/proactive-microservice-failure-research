...
| P2-MINIKUBE-STATE-POSTMORTEM-001 / ob-minikube-state-postmortem-001 | 2026-08-29 | planned | D-075 sonrası gerçek state-root provenance'ını ve durmuş profile'ın erişilebilir postmortem kanıtını toplamak | D-076 read-only operasyonel preregistration; dataset/headroom dışı; application/workload/fault yok | External/resolved/expected MINIKUBE_HOME; exact profile/container/volume; config/lastStart/Docker/Minikube logs; no mutation; semantic verifier/seal | Canlı execution yok; path/Docker/profile/stopped-container artifact-before fail-closed kapıları ve forbidden-mutation contract testi hazırlanır | `p0-env/artifacts/P2-MINIKUBE-STATE-POSTMORTEM-001/ob-minikube-state-postmortem-001-preregistration.md` | Canonical merge ve ayrı runtime onayı gerekir; başarı profile delete/bootstrap/application/replacement/fault yetkisi vermez; D-067 değişmez |
