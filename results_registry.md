...
| P1-CPU-001 / ob-cpu-medium-004 | 2026-08-06 | planned | Invalid 002 yerine üçüncü geçerli medium adayını toplamak | `cpu-recommendation-medium-v1`; 001/003 koşulları ve D-026 değişmez | Ayrı canonical revision, run ID, artifact, host ve receipt zinciri | Merge, temiz preflight ve ayrı yürütme onayı bekleniyor | `p0-env/artifacts/P1-CPU-MEDIUM-PREREG-001/attempt-004.md` | Geçerse D-025 üç-valid-run betimsel özeti yapılabilir; high severity otomatik yetkili değildir |
