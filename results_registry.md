...
| P2-NETWORK-DELAY-SERVER-TERMINATION-DIAG-001 / ob-network-server-termination-001 | 2026-08-15 | planned | O-018 server exit 137/CrashLoopBackOff temel nedenini faultsuz ayrıştırmak | Diagnostic; dataset/modeling dışı; toxic/fault yok | 180 sn / 5 sn; pod/container, events/describe/log, node/resource/metrics/kubelet, rollback/host | Ön-kayıt ve contract testi | `p0-env/artifacts/P2-NETWORK-DELAY-SERVER-TERMINATION-DIAG-001/preregistration.md` | Sonuçtan önce probe/resource/timeout veya replacement değişikliği yok |
