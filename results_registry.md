...
| P1-CPU-001 / ob-cpu-medium-001 | 2026-08-06 | planned | İlk orta şiddetli CPU kalibrasyonunu toplamak | `cpu-recommendation-medium-v1`; 100m; min +50m; aynı workload/seed/SLO | 5 dk warm-up + 5 dk baseline + 120 sn ramp + 300 sn steady + 5 dk cooldown; coverage 48/60 | Bekleniyor; profil/tooling merge ve ayrı yürütme onayı öncesi başlamaz | `p0-env/artifacts/P1-CPU-MEDIUM-PREREG-001/attempt-001.md` | İlk medium calibration; null sonuç geçerli olabilir, high severity otomatik yetkili değildir |
