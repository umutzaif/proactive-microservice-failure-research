...
| P2-NETWORK-DELAY-BASE-READINESS-DIAG-001 / ob-network-base-readiness-008 | 2026-09-02 | planned | D-094 clean reconstruction sonrası application readiness/stability durumunu yeniden doğrulamak | D-095 preregistered operational diagnostic; dataset/headroom dışı; runtime yetkisiz | D-094 closed evidence; değişmeyen pinned source + base + 10u; overlay/toxic/fault yok; 900/5 convergence + 180/5 UID/server Ready/restart stability; host/stop/verifier/seal | Repository hazırlığı; canlı gözlem yok | `p0-env/artifacts/P2-NETWORK-DELAY-BASE-READINESS-DIAG-001/ob-network-base-readiness-008-preregistration.md` | Canonical merge ve ayrı runtime onayı gerekir; profile delete/reset yok; D-067 15u 2/3, 10u 1/3 kalır; replacement/fault yetkisi yok |
