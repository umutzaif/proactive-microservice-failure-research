...
| P2-KUBERNETES-BOOTSTRAP-STATE-CONSISTENCY-DIAG-001 / ob-k8s-bootstrap-state-consistency-003 | 2026-08-31 | planned | D-083 sonrası state-consistency sorusunu aynı koşullarda yeniden test etmek | D-084 operational replacement preregistration; dataset/headroom dışı | Preserved stopped profile; v1.34.0/4 CPU/6144 MiB/32 GiB/containerd/420/5; inspect/process/state/CRI/host/verifier/seal fail-closed gates | Runtime yok; PowerShell 5.1/7 native, runtime, verifier ve contract fixture'ları geçti | `p0-env/artifacts/P2-KUBERNETES-BOOTSTRAP-STATE-CONSISTENCY-DIAG-001/ob-k8s-bootstrap-state-consistency-003-preregistration.md` | Canonical merge ve ayrı runtime onayı gerekir; `001/002` ve D-067 değişmez |
