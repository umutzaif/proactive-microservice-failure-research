...
| P2-NETWORK-DELAY-BASE-READINESS-DIAG-001 / ob-network-base-readiness-007 | 2026-09-01 | planned | `006` semantic-verifier closure invalidliğini aynı application sözleşmesiyle telafi etmek | D-089 preregistered operational replacement; dataset/headroom dışı; runtime yetkisiz | Alias-safe host variable; PS5.1/7 valid fixture; child exit fail-closed; değişmeyen source/base+10u/900+180/no fault | Repository hazırlığı; canlı gözlem yok | `p0-env/artifacts/P2-NETWORK-DELAY-BASE-READINESS-DIAG-001/ob-network-base-readiness-007-preregistration.md` | Canonical merge ve ayrı runtime onayı gerekir; D-067 değişmez |
