...
| P1-CPU-LOW-PREREG-001 | 2026-08-03 | completed | İlk düşük CPU kalibrasyonunu fault verisi öncesi preregister etmek ve güvenlik araçlarını doğrulamak | Tooling/preregistration; bilimsel dataset değil | recommendationservice; 50m; 120 sn ramp; 300 sn steady; bounded worker; Prometheus etki kapısı | Worker bounded test, CPU-effect pozitif/negatif fixture, fault-metadata pozitif/negatif fixture ve parser kontrolleri geçti | `p0-env/artifacts/P1-CPU-LOW-PREREG-001/` | Fault uygulanmadı; canlı preflight ve temiz committed revision geçmeden `ob-cpu-low-001` başlayamaz |
