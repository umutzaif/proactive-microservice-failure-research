...
| P1-WORKLOAD-CAPACITY-001 | 2026-08-10 | planned | İkinci workload seviyesini fault outcome'u kullanmadan seçmek | Tooling/karar desteği; dataset değil | 20 -> 10 -> 15 users; 300 sn warm-up + 300 sn measurement; seed 20260810 | Active run-ID, pod/host/telemetry, frozen-SLO, request-intensity ve CPU-headroom kapıları sonuç öncesi donduruldu | `p0-env/artifacts/P1-WORKLOAD-CAPACITY-001/preregistration.md` | Fault uygulanmaz; eşikler sonuçtan sonra gevşetilmez; seçim olmadan ikinci-workload bilimsel run başlamaz |
