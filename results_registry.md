...
| P2-KUBERNETES-BOOTSTRAP-DIAG-001 / ob-k8s-bootstrap-recovery-001 | planned | planned | D-084 partial existing-state sonrasında clean reconstruction recoverability sınamak | D-085 preregistered operational diagnostic; runtime/delete ayrı onaylı; dataset/headroom dışı | Pre-delete exact evidence; exact profile delete/yokluk; değişmeyen v1.34.0/4 CPU/6144 MiB/32 GiB/containerd; 180/5 system stability | Canlı sonuç yok | `p0-env/artifacts/P2-KUBERNETES-BOOTSTRAP-DIAG-001/ob-k8s-bootstrap-recovery-001-preregistration.md` | Application/workload/fault yok; başarı state originini veya benzersiz kök nedeni kanıtlamaz |
