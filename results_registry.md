...
| P2-NETWORK-DELAY-HEADROOM-001 / ob-netdelay-500m-normal-15u-002 | 2026-08-21 | planned | D-067 etkili sıranın ikinci 15u no-toxic normalini toplamak | Preregistered normal; fault yok | 15u/rate1/seed1; 500m/100m/100m; no-toxic; 120s stability; 300/300; 60/48; null SLO; pod/host/schema-v3/rollback/receipt | Aktif run/workload bağı, runner/verifier ID-seed sözleşmesi, parse/no-fault, metadata fixture ve WhatIf canlıdan önce zorunlu | `p0-env/config/analysis/network-delay-headroom-decision-inputs-v1.json` | Yalnız tüm close gate'ler geçerse ikinci geçerli 15u tekrar; akademik karar üretmez |
