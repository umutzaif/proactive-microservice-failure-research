...
| O-003 | Failure manifestation için ana SLO nedir? | Üç geçerli normal run'da pencere-p95 latency p99 4.279,712 ms ve 2.219 istekte hata 0. DNS patch A/B/A testi cold-start ve cache carry-over nedeniyle inconclusive oldu; patch kabul edilmedi. İzole cache + eşlenmiş concurrent workload kanıtı veya açık route-specific/global SLO kararı gerekli | Pilot P1 |
