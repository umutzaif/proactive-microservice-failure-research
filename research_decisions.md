...
| O-019 | Server 8080 gRPC liveness probe'u 1 saniyede neden yanıt vermedi? | Contemporaneous CPU/memory/cgroup ve probe latency kanıtı; metrics API tanıda yoktu. CPU starvation, runtime stall ve diğer responsiveness nedenleri ayrılmalı | Ayrı faultsuz ölçüm/tasarım kararı; probe/resource değiştirilmeden |
