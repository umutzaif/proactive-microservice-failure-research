...
| O-018 | Tek proxy pod 120 saniye boyunca neden Ready olmadı? | `readiness-002` 33 gözlemde proxy 33/33, server 31/33 Ready ile kalıcı sorunu yeniden üretmedi; log seçimindeki eksik `deletionTimestamp` nedeniyle incomplete. Kalan null-safe erişim, current events/log kapsamı ve yeni ID ile kapanış tekrarlanmalı | P2 no-fault proxy readiness diagnosis |
